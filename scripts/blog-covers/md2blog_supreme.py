# 칼럼 md → 블로그 HTML(인라인 스타일). 인용 배너(>)·H1·「확인할 것」 절은 제외, 「(2026.9.24 원문 확인)」 메모 제거. 표지 이미지는 __IMAGE_URL__ 자리표시.
import io, re, sys, html
sys.stdout.reconfigure(encoding='utf-8')
SRC = 'C:/Users/lacoi/Desktop/hybrid-jury-system/docs/columns/2026-09-23_대법관_한_자리는_누구의_것인가.md'
OUT = 'C:/Users/lacoi/AppData/Local/Temp/claude/C--Users-lacoi-Desktop-hybrid-jury-system/da59800c-4141-4bad-befe-989bf4ce34bd/scratchpad/blog_post_supreme.html'
...
out = []
out.append('<p style="color:#5C6470;font-size:0.95em">헌법 제104조 읽기</p>')
out.append('<figure style="margin:28px 0"><img src="__IMAGE_URL__" alt="대법관 한 자리는 누구의 것인가" style="width:100%;height:auto;border-radius:10px"></figure>')
...
for raw in lines:
    ...
    if ln.startswith('## '):
        out.append(f'<h2 style="margin:40px 0 14px;font-size:1.35em;line-height:1.35;color:#1B2230;border-left:6px solid #C8271E;padding-left:12px">{inline(ln[3:])}</h2>'); continue
    if ln.startswith('### '):
