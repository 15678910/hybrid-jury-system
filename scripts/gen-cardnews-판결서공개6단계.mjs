...
{ step:'2단계', title:'형사와 민사가 다르다', sub:'같은 「판결서 열람」인데 조문 제목부터 다르다 (원문 대조)', page:'2 / 6',
 cols:[
  {n:'1',t:'형사 — 확정된 것만',items:[
   ['조문 제목이 「<b>확정</b> 판결서등의 열람·복사」','형소법 제59조의3 (2027.12.30.까지)'],
   ['제한 사유 5개 호 — 비공개 심리·소년사건·증거인멸 우려·국가안전보장 등','같은 조 ① 단서'],
   ['<b>검색 제공 의무가 없다</b> — 2027.12.31.부터 생긴다','같은 조 ② (2025.12.30. 신설)'],
  ],warnDots:[2]},
  ...
  {n:'3',t:'연혁 — 부칙에서 확인',items:[
   ...
   ['형사 — <b>2027. 12. 31.</b>부터 같은 기준','법률 제21241호 부칙 제1조'],
  ],tight:true},
 ],
 warn:'요약 — 지금은 민사가 형사보다 넓다. 민사는 확정 전에도 열리고 검색까지 의무인데, 형사는 2027.12.30.까지 확정돼야 열린다. 두 조문을 바꿔 쓰지 말 것',
 bottom:'같은 「공개」인데 — <span class="k">민사는 문이 넓고 형사는 아직 좁다</span>'},
// ───────────────────────── 3단계
{ step:'3단계', title:'막히는 지점 다섯', sub:'조문을 끝까지 읽으면 보이는 구멍들', page:'3 / 6',
 cols:[
  {n:'1',t:'범위의 구멍',items:[
   ['형사 <b>미확정 비공개</b> — 진행 중 재판은 판결문으로 검증할 수 없다','형소법 제59조의3① (2027.12.30.까지)'],
   ['민사 <b>소액사건 제외</b> — 생활 분쟁의 다수가 공개 대상 밖','민소법 제163조의2① 괄호'],
  ]},
  {n:'2',t:'방식의 구멍',items:[
   ['<b>검색 의무는 민사에만</b> 있다 — 형사는 <b>2027.12.31.</b>에야 생긴다','민소법 제163조의2② · 형소법 제59조의3② (시행 대기)'],
   ['무료·기계판독·오픈 API — <b>어느 조문에도 없다</b>. 건별 열람으로는 대량 검증 불가'],
  ],warnDots:[1]},
  {n:'3',t:'불복의 구멍',items:[
   ['열람 제한에 불복할 수 있는 사람이 「<b>소송관계인·이해관계 있는 제3자</b>」뿐','형소법 제59조의3④⑤ (2027년부터 ⑤⑥)'],
...
{ step:'4단계', title:'이미 바뀌고 있다', sub:'형사 미확정 공개 — 공포는 됐고, 시행을 기다린다 (원문 확인)', page:'4 / 6',
 cols:[
  ...
  {n:'3',t:'함께 확인한 것',items:[
   ...
   ['개정 후 조문 — <b>미확정 판결서 포함</b>, 제한 사유 <b>제6호 신설</b>, <b>검색 제공 의무 신설</b>','형소법 제59조의3①·② (2027.12.31. 시행분 대조)'],
   ['다만 증거목록 등 <b>판결서 외 문서는 여전히 확정 사건만</b>','같은 조 ① 괄호'],
  ],warnDots:[2]},
 ],
...
{ step:'5단계', title:'제안 — 남은 것을 완성하라', sub:'입법이 잡은 방향을 데이터까지 밀고 간다', page:'5 / 6',
 ...
 cols:[
  {n:'1',t:'범위를 마저 연다',items:[
   ...
   ['형사 검색 제공은 <b>이미 입법됐다</b> — 남은 것은 <b>대법원규칙이 좁히지 않게</b> 하는 것','형소법 제59조의3② (2027.12.31. 시행)'],
  ]},
  {n:'2',t:'형식을 바꾼다',items:[
   ['<b>무료 · 기계판독 형식 · 오픈 API</b>'],
   ['수수료는 대법원규칙 사항 — <b>규칙 개정만으로도 움직일 수 있다</b>','형소법 제59조의3⑥ (2027년부터 ⑧)'],
