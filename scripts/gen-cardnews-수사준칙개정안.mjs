...
//   · 헌법 제75조·제89조                             docs/bills/헌법_원문.txt
// 5단계는 평가, 6단계는 제안, 7단계는 질문임을 배지로 명시한다.
// 7단계의 주체는 주권자사법개혁추진준비위원회다 — 준비위가 정보를 모아 문제를 이슈화하고
// 이재명 정부에 「정부의 뜻인가」를 묻는 구도. 조국혁신당 국회 기자회견(2026-09-02, 국회 소통관,
// 국민TV 생중계 https://www.youtube.com/watch?v=auCjQmh7Wzk)은 같은 지적이 있었다는 참고로만 한 줄 적는다.
// (2026-09-02 사용자 지시: 조국혁신당이 주체가 될 이유가 없다.)
import fs from 'fs';
...
// ───────────────────────── 7단계
{ step:'7단계', title:'이재명 정부에 묻는다', sub:'이 개정령안은 정부의 뜻인가 — 주권자가 판단할 수 있도록 묻는다', page:'7 / 7',
 ...
 cols:[
  {n:'1',t:'대통령령은 대통령의 이름으로 나온다',items:[
   ...
   ['「대통령령안」은 <b>국무회의의 심의</b>를 거쳐야 한다 — 법무부가 올린 안을 국무회의가 의결하고 대통령이 공포한다','헌법 제89조 제3호 · 개정령안 의결주문'],
   ['시행일 <b>2026년 10월 2일</b> — 개정 형소법 시행일과 같은 날','개정령안 부칙 제1조'],
  ],quote:[0,1],tight:true},
  {n:'2',t:'준비위가 확인한 것',items:[
   ['법에 없던 <b>호송 협조 의무</b>가 생긴다 (제29조의2 ②)','2단계 · 형소법 제201조⑦ 대조'],
   ['사경 「하여야 한다」 셋, 검사 「요구할 수 있다」 — <b>수직 관계</b> (제8조의3)','3단계 · 형소법 제195조① 대조'],
   ['특사경은 지도·조언을 <b>「이행해야 한다」</b> (제정안 제25조 ③)','4단계 · 형소법 제245조의10 대조'],
   ['9월 2일 조국혁신당도 국회 기자회견에서 「검사지휘권 부활 시도」라 지적했다','국민TV 생중계 2026.9.2.'],
  ],tight:true},
  {n:'3',t:'묻는다',items:[
   ['① 개정 형소법이 지운 「지휘」를 <b>대통령령으로 되살리는 것</b>이 정부의 뜻인가'],
   ['② 호송 의무(제29조의2 ②)를 <b>국무회의에서 그대로 의결</b>할 것인가'],
   ['③ 입법예고 마감(9월 4일) 전에 <b>사법제도비서관실 회의를 재소집</b>해 의견을 들을 것인가'],
   ['정부의 답과 국무회의 결과를 <b>이 카드에 이어 기록한다</b>','주권자사법개혁추진준비위원회(준)'],
  ],warnDots:[0,1,2],tight:true},
 ],
 bottom:'<span class="pre">질문</span>법을 만든 정부가 — <span class="k">법을 되돌리는 대통령령에 서명할 것인가</span>'},
];
