...
// ───────────────────────── 7단계
{ step:'7단계', title:'핵심 인용', sub:'개정안을 둘러싼 말 — 발언자·출처는 확인 후 기재한다', page:'7 / 7',
 cols:[
  {n:'1',t:'글자 몇 개의 문제가 아니다',items:[
   ['「검찰 개혁은 법에서 수사권이라는 글자 몇 개를 지우는 것으로 끝나지 않습니다. 검사가 수사 기관의 <b>상관이라는 오랜 선민의식과 조직 문화</b>까지 걷어내야 비로소 기소의 분리가 완성됩니다.」','발언자·출처 — 확인 중 (기재 보류)'],
  ],quote:[0]},
  {n:'2',t:'협력의 뜻',items:[
   ['「협력은 의견을 주고받는 것이지 <b>한쪽의 의견을 사실상 따르게 만드는 것</b>이 아닙니다. … 법무부는 검사가 수사 기관보다 우월하다는 <b>낡은 인식부터 버려야</b> 할 것입니다.」','발언자·출처 — 확인 중 (기재 보류)'],
  ],quote:[0]},
  {n:'3',t:'막아야 할 것',items:[
   ['「경찰에게 <b>이전엔 없던 호송 의무</b>를 부과하는 그러한 대통령령이 제정되는 것은 <b>반드시 막아야</b> 한다고 생각합니다.」','발언자·출처 — 확인 중 (기재 보류)'],
