...
const DEFAULT_VERDICTS = [
    ...
    },
    {
        ...
        judge: '한성진 부장판사',
        charge: '내란중요임무종사 (계엄 해제 표결 방해)',
        sentence: '미선고 (공판 진행 중)',
        prosecution: '-',
        status: 'pending',
        detail: '12·3 계엄 선포 후 국민의힘 의원총회 장소를 국회→당사→국회→당사로 3차례 변경, 소속 의원 90명(108명 중)이 계엄 해제 표결에 불참하도록 유도한 혐의. 2026.3.25 첫 공판서 "내란몰이 정치공작"이라며 혐의 부인. 2026.6.10 공판기일.'
    },
    {
        date: '2026.04.29',
        defendant: '윤석열',
    ...
    },
    {
        ...
        judge: '조순표 부장판사',
        charge: "'매관매직' 알선수재 (특정범죄가중처벌법) — 12·3 내란과 별개 권력형 비리",
        sentence: '징역 7년',
        prosecution: '징역 7년 6개월 (특검)',
        status: 'convicted',
        detail: '이봉관 서희건설 회장에게 공직 임명·국가교육위원장·공천 청탁 명목 반클리프·금거북이·바쉐론 시계·이우환 그림·디올백 등 수수. 알선수재 세부 5개 혐의 전부 유죄 — 재판부 "위법성 인식하며 은폐". 도이치·통일교 사건과 별개의 1심 선고(생중계).'
    },
    {
        date: '2026.06.22',
        defendant: '박성재',
        ...
        judge: '이진관 부장판사',
        charge: '내란중요임무종사·직권남용 (형법 제87조·제123조)',
        sentence: '징역 25년 (법정구속)',
        prosecution: '징역 20년 (조은석 특검)',
        status: 'convicted',
        detail: '재판부: 합수본 검사 파견 준비·교정시설 수용공간 확보·출국금지 요원 대기 등은 "윤석열 지시를 그대로 이행" → 내란 중요임무 실행 인정. 특검 구형(20년)보다 5년 무거운 25년 선고, 증거인멸 우려로 법정구속. 김건희 수사청탁 관련 혐의는 내란 특검 수사범위가 아니라며 공소기각.'
    },
    {
        date: '2026.01.06',
        defendant: '윤석열',
    ...
    },
    {
        date: '2026.05.07',
        defendant: '한덕수',
        court: '서울고법 내란전담재판부 (항소심)',
        charge: '내란중요임무종사, 허위공문서작성',
        sentence: '징역 15년 (1심 23년→감형)',
        prosecution: '징역 23년 (특검)',
        status: 'convicted',
        detail: '2심: 12·3을 1심과 같이 국헌문란 목적의 내란으로 규정(첫 항소심 내란 판단). 대부분 유죄를 유지하되 국무회의 심의 외관 형성 등 일부는 무죄로 파기. 사전 모의·주도가 아니고, 계엄 해제 국무회의를 소집·주재해 약 6시간 만에 해제된 점을 유리한 정상으로 보아 23년→15년 감형.'
    },
    {
        date: '2026.01.28',
        defendant: '김건희',
    ...
    },
    {
        ...
        court: '서울고법 (항소심)',
        charge: '내란중요임무종사, 헌재 위증',
        sentence: '징역 9년 (1심 7년→가중)',
        prosecution: '징역 15년 (특검)',
        status: 'convicted',
        detail: '2심: 1심의 유·무죄 판단은 그대로 유지하되 "1심 형량(7년)이 지나치게 낮다"는 조은석 특검의 양형부당 주장을 받아들여 7년→9년 가중. 언론사 단전·단수 지시 등 내란 가담.'
    },
    {
        date: '2026.02.19',
        defendant: '윤석열',
    ...
    },
    {
        ...
        defendant: '박성재',
        court: '서울중앙지법 형사합의33부',
        charge: '내란중요임무종사·직권남용',
        sentence: '징역 25년 (법정구속)',
        prosecution: '징역 20년 (특검)',
        status: 'convicted',
        detail: '법무부 장관, 내란 가담 — 1심 징역 25년·법정구속 (2026.6.22, 이진관 부장판사). 김건희 수사청탁 혐의는 공소기각.'
    },
    {
        date: '2026.07.09',
        defendant: '박종준',
        court: '서울중앙지법 형사합의26부',
        charge: '특수공무집행방해·직권남용·범인은닉',
        sentence: '징역 4년 (법정구속)',
        prosecution: '구형 징역 7년 (내란 특검)',
        status: 'convicted',
        detail: '전 대통령경호처장. 2025.1 공수처의 윤석열 체포영장 집행을 경호처 직원·차벽 동원으로 방해한 혐의. 2026.7.9 1심 징역 4년·법정구속(형사26부 이현경, 구형 7년). 재판부: "경호처 국가기관의 조직·지휘·체계를 이용한 장기간 영장집행 차단은 중대 범죄". ※ 별건 증거인멸 혐의는 2026.5.21 1심 무죄(형사32부 류경진).'
    },
    {
        date: '2026.07.09',
        defendant: '김성훈',
        ...
        prosecution: '구형 징역 7년 (내란 특검)',
        status: 'convicted',
        detail: '전 대통령경호처 차장. 박종준 전 처장과 공모해 윤석열 체포영장 집행을 저지한 혐의. 2026.7.9 1심 징역 5년·법정구속(형사26부 이현경, 구형 7년) — 같은 구형이나 박종준(4년)보다 무거운 형. 별건 비화폰 기록 삭제 직권남용은 진행 중.'
    },
    {
        date: '',
        defendant: '여인형',
    ...
    },
    {
        ...
        defendant: '윤석열',
        court: '권창영 종합특검',
        charge: '군형법상 반란 우두머리 (군형법 §5 · 2차 계엄)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '【군사반란(2차 계엄)】 국회의 계엄 해제 요구 후에도 병력을 철수시키지 않고 합참·육본 중심으로 계엄을 이어가려 한 행위를 군형법상 반란으로 보고 6.13 2차 소환조사. 형법상 내란(수괴)과 별개의 군형법 반란 혐의 — 추가 기소 여부 미정.'
    },
    {
        date: '',
        defendant: '정진팔',
        court: '권창영 종합특검',
        charge: '내란중요임무종사 (합참 차장)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '전 합참 차장. 12·3 당시 합참 지휘통제실에서 병력의 국회 투입을 파악하고도 제지하지 않고 계엄사령부 구성에 관여한 혐의. 6.15 구속. (현재 죄명은 형법상 내란중요임무종사 — 특검은 군형법상 반란죄 적용 확대 검토 중)'
    },
    {
        date: '',
        defendant: '김흥준',
        court: '권창영 종합특검',
        charge: '내란중요임무종사 (육군본부 정책실장)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '전 육군본부 정책실장. 12·3 비상계엄 실행을 뒷받침(계엄사령부 구성 관여)한 혐의. 6.15 구속, 6월 말 기소 방침.'
    },
    {
        date: '',
        defendant: '이재식',
        court: '권창영 종합특검',
        charge: '내란중요임무종사 (합참 전비태세검열차장)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '전 합참 전비태세검열차장. 12·3 비상계엄 실행을 뒷받침(계엄사령부 구성 관여)한 혐의. 6.15 구속, 6월 말 기소 방침.'
    },
    {
        date: '',
        defendant: '김명수',
        court: '권창영 종합특검',
        charge: '내란중요임무종사 (前 합참의장)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '전 합동참모본부 의장. 종합특검이 6.9 내란중요임무종사 혐의로 구속영장 청구했으나, 6.15 "혐의 성립에 다툼의 여지가 있고 퇴직자라 증거인멸 우려가 크지 않다"며 영장 기각 — 불구속 수사. (전 대법원장 김명수와 동명이인)'
    },
    {
        date: '',
        defendant: '조성현',
        ...
        prosecution: '',
        status: 'pending',
        detail: '前 수방사 1경비단장(대령). 이진우 전 사령관의 "의원 끌어내라" 국회 출동 지시를 휘하 부대에 하달한 혐의로 6.27 입건. 다만 이튿날 "서강대교 넘지 말라"로 진입 차단, 국방부 보국훈장 수여·대통령 격려 — 공로자 입건 논란. (현재 죄명은 형법상 내란중요임무종사 — 특검은 군형법상 반란죄 적용 확대 검토 중)'
    },
    {
        date: '',
        defendant: '조태용',
    ...
    },
    {
        ...
        charge: '내란중요임무종사·직권남용권리행사방해',
        sentence: '',
        prosecution: '구속영장 청구 (종합특검)',
        status: 'pending',
        detail: '전 국가안보실 1차장. 2차 종합특검(특별검사 권창영)이 2026.7.7 구속영장 청구 — 12·3 계엄 직후 외무 공무원을 통해 미국 등 우방국에 계엄 정당화 메시지를 전달(필립 골드버그 당시 주한미국대사 설득)한 의혹. 구속 전 피의자심문 대기. 같은 혐의로 입건된 신원식 전 안보실장은 가담 정도가 가볍다고 보고 영장 미청구.'
    },
    {
        date: '',
        defendant: '심우정',
...
const VERDICT_COMPARISON_ANALYSIS = {
    ...
    historicalBenchmark: [
        ...
        { event: '12.3 비상계엄', year: '2024', defendant: '정진팔', charge: '내란중요임무종사 (합참 차장)', sentence: '구속·기소 방침', note: '6.15 구속, 6월 말 기소 방침' },
        { event: '12.3 비상계엄', year: '2024', defendant: '김흥준', charge: '내란중요임무종사 (육본 정책실장)', sentence: '구속·기소 방침', note: '6.15 구속, 6월 말 기소 방침' },
        { event: '12.3 비상계엄', year: '2024', defendant: '이재식', charge: '내란중요임무종사 (합참 전비태세검열차장)', sentence: '구속·기소 방침', note: '6.15 구속, 6월 말 기소 방침' },
        { event: '12.3 비상계엄', year: '2024', defendant: '김명수', charge: '내란중요임무종사 (前 합참의장)', sentence: '영장 기각·불구속', note: '6.15 구속영장 기각 — 다툼 여지·증거인멸 우려 낮음' },
        ...
        { event: '12.3 비상계엄', year: '2024', defendant: '한덕수', charge: '내란중요임무종사', sentence: '1심 23년→2심 15년', note: '국무총리. 2심(5.7) 8년 감형 — 계엄 해제 국무회의 소집·주재 등 참작' },
        { event: '12.3 비상계엄', year: '2024', defendant: '이상민', charge: '내란중요임무종사', sentence: '1심 7년→2심 9년', note: '행안부장관. 2심(5.12) 2년 가중 — 특검 양형부당 수용' }
    ]
};
    ...
    },
    {
        ...
        actualVerdict: {
            ...
            issues: [
                ...
                '국무총리 헌법적 책임 가중 반영',
                '다른 피고인 대비 양형 형평성 논란',
                '★ 항소심(2026.5.7): 1심 23년→2심 15년 감형 — 12·3을 내란으로 재확인하되, 계엄 해제 국무회의를 소집·주재해 약 6시간 만에 해제된 점 등을 유리한 정상으로 참작'
            ]
        },
        aiPrediction: {
            sentence: '징역 25~30년',
    ...
    },
    {
        ...
        actualVerdict: {
            ...
            issues: [
                ...
                '형사소송법 298조 ② 위반 — "법원은 심리의 경과에 비추어 상당하다고 인정할 때에는 공소사실 또는 적용법조의 추가 또는 변경을 요구하여야 한다." 우인성 판사는 내란공모·방조범 적용법조 추가를 요구하지 않음. 반면 이진관 판사(형사합의33부)는 한덕수 사건에서 형소법 298조 ②에 따라 방조죄에서 내란중요임무종사로 적용법조 변경을 적극 요구하여 실행함'
            ]
        },
        aiPrediction: {
            sentence: '징역 8~12년',
        ...
        layJudgeSimulation: {
            ...
            citizenPerspective: [
                ...
                '형소법 298조 ② 미이행 — 이진관 판사는 한덕수 사건에서 적용법조 변경을 요구했으나, 우인성 판사는 방조범 추가를 요구하지 않아 시민법관이 견제 가능'
            ],
    ...
    },
    {
        ...
        actualVerdict: {
            ...
            issues: [
                ...
                '한덕수(153%)와 극단적 양형 격차',
                '★ 항소심(2026.5.12): 1심 7년→2심 9년 가중 — 1심 유·무죄는 유지하되 형량이 지나치게 낮다는 특검 양형부당 주장 수용'
            ]
        },
        aiPrediction: {
            sentence: '징역 12~15년',
    ...
    judiciary: [
        {
            ...
            description: '우인성 판사가 도이치모터스 주가조작을 3개 범행으로 분리하여 대법원 포괄일죄 판례에 정면 위배되는 판결. 특검도 "대법원 판결에 위배되는 판결"이라고 공식 비판. 또한 1971년 서병호 간첩 조작 고문 사건에 대해 진실화해위원회가 재심을 결정했음에도 이를 기각한 전력이 있는 판사. 형사소송법 298조 ②("법원은 심리의 경과에 비추어 상당하다고 인정할 때에는 공소사실 또는 적용법조의 추가 또는 변경을 요구하여야 한다")에 따른 방조범 적용법조 추가를 요구하지 않음. 반면 이진관 판사(형사합의33부)는 동일 조항에 따라 한덕수 사건에서 방조죄→내란중요임무종사로 적용법조 변경을 적극 실행.',
...
export default function InsurrectionTrialAnalysis() {
    ...
    return (
        <>
            <SEOHead title="내란재판종합분석" description={`참심제 시뮬레이션 - ${new Date().getFullYear()}년 ${new Date().getMonth() + 1}월 ${new Date().getDate()}일, 내란 27명 피고인 판결분석, AI 양형예측 vs 참심제 시뮬레이션 비교 - 시민법정`} path="/trial-analysis" image="/참심제시뮬레이션.png" />
            <Header />
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-3 text-sm mb-4">
                                    ...
                                    <div className="bg-amber-50 border border-amber-100 rounded-lg p-3">
                                        ...
                                        <p className="text-gray-700 text-xs leading-relaxed">군인이 작당하여 병기를 휴대하고 반란을 일으킨 죄(군인 신분범). 1979년 12.12(전두환 반란수괴)가 대표 사례로, 형이 더 무겁다(반란수괴=사형). 종합특검은 12·3의 '2차 계엄 시도'(국회의 계엄 해제 요구 이후에도 병력을 철수시키지 않은 행위)를 군형법상 반란으로 보고 윤석열·김용현 등을 반란 혐의로 수사 중이며, 정상 지휘체계(합참의장)를 벗어나 병력을 동원한 12·3 군 지휘관들에게도 (내란죄와 별개로) 반란죄를 적용해야 한다는 주장·수사 확대가 이어지고 있다.</p>
                                    </div>
                                </div>
                                {/* 조성현 입건 논란 분석 */}
                                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm mb-4">
                                    ...
                                    <p className="text-gray-700 text-xs leading-relaxed">종합특검(권창영)은 조 대령이 이진우 전 수방사령관의 "의원들을 끌어내라"는 지시를 휘하 부대에 하달한 점을 형법상 내란중요임무종사로 보고 입건했다(현재 죄명 기준 — 특검은 12·3 군 지휘관들에 대한 군형법상 반란죄 적용 확대도 검토 중). 다만 조 대령은 이튿날 새벽 "서강대교를 넘지 말라"며 국회 진입을 사실상 차단했고, 국방부는 2025.9 그에게 보국훈장(삼일장)을, 이재명 대통령도 격려를 한 바 있어 — <b>불법 명령에 저항한 공로자를 내란 피의자로 입건하는 것이 타당한가</b>를 두고 논란이 있다. 특검은 최초 지시 하달만으로도 혐의가 성립할 수 있다고 보고 다음 달 초 소환조사할 방침이다. (수사 단계)</p>
                                </div>
                                <div className="overflow-x-auto">
                                    <table className="w-full text-sm">
                                        <thead>
