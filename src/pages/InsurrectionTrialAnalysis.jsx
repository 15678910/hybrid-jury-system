...
const DEFAULT_VERDICTS = [
    ...
    },
    {
        ...
        prosecution: '',
        status: 'pending',
        detail: '전 합참 차장. 12·3 당시 합참 지휘통제실에서 병력의 국회 투입을 파악하고도 제지하지 않고 계엄사령부 구성에 관여한 혐의. 6.15 구속, 6월 말 기소 방침. (형법상 내란중요임무종사 — 군형법 반란 아님)'
    },
    {
        date: '',
        defendant: '김흥준',
    ...
    },
    {
        ...
        prosecution: '',
        status: 'pending',
        detail: '前 수방사 1경비단장(대령). 이진우 전 사령관의 "의원 끌어내라" 국회 출동 지시를 휘하 부대에 하달한 혐의로 6.27 입건. 다만 이튿날 "서강대교 넘지 말라"로 진입 차단, 국방부 보국훈장 수여·대통령 격려 — 공로자 입건 논란. (형법상 내란중요임무종사)'
    },
    {
        date: '',
        defendant: '조태용',
