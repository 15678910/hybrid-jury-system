...
const DEFAULT_VERDICTS = [
    ...
    },
    {
        ...
        court: '서울고법 형사1부',
        judge: '윤성식 부장판사',
        charge: '체포방해, 직권남용, 허위공문서작성, 대통령기록물법 위반 (대법원 확정)',
        sentence: '징역 7년 (대법원 확정)',
        prosecution: '징역 10년 (특검)',
        status: 'convicted',
        detail: '1심 5년 → 항소심 7년 → 2026.7.9 대법원 상고기각·징역 7년 확정(대법원 3부, 재판장 이흥구·주심 이숙연). "대통령으로서의 책무를 저버렸다" — 윤석열 관련 첫 대법원 판단'
    },
    {
        date: '2026.04.28',
        defendant: '김건희',
    ...
    },
    {
        ...
        court: '서울고법 형사15-3부',
        judge: '성언주 부장판사',
        charge: "'매관매직' 알선수재 (특정범죄가중처벌법) 항소심 — 12·3 내란과 별개 권력형 비리",
        sentence: '징역 5년 (1심 7년→감형)',
        prosecution: '징역 7년 6개월 (특검, 1심 구형)',
        status: 'convicted',
        detail: '2심: 바쉐론 시계·세한도 복제본 2건 무죄로 2년 감형, 반클리프 목걸이·귀걸이·금거북이·이우환 그림·디올백 유죄 유지. 이우환 그림·반클리프 목걸이·디올 파우치 몰수, 2,440만원 추징. 재판부 "대통령 배우자로서 영향력을 행사한다는 걸 알 수 있었음에도 자신의 지위를 망각한 채 아무런 거리낌 없이 반복해 금품을 수수했다". 김건희 측 상고 방침.'
    },
    {
        date: '2026.06.22',
        defendant: '박성재',
    ...
    },
    {
        ...
        judge: '이현경 부장판사',
        charge: '내란중요임무종사 (형법 제87조)',
        sentence: '징역 9년 (보석 취소·재구금)',
        prosecution: '징역 20년 (내란특검)',
        status: 'convicted',
        detail: '전 특전사령관, 국회 진입 작전 지휘. 2026.9.21 1심 (형사26부 이현경). 재판부: "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다". 5명 중 최저형. 선고와 함께 보석 취소·재구금.'
    },
    {
        date: '2026.09.21',
        defendant: '문상호',
        court: '서울중앙지법 형사합의26부',
        judge: '이현경 부장판사',
        charge: '내란중요임무종사·직권남용 (군사기밀 누설은 무죄)',
        sentence: '징역 12년',
        prosecution: '징역 20년 (내란특검)',
        status: 'convicted',
        detail: '전 국군정보사령관, 선관위 병력 투입·계엄 사전 모의. 2026.9.21 1심 (형사26부 이현경). 재판부: "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다". 군사기밀 누설 혐의는 고의를 인정하기 어렵다며 무죄. 별건 구속 유지.'
    },
    {
        date: '2026.09.21',
        defendant: '박안수',
        court: '서울중앙지법 형사합의26부',
        judge: '이현경 부장판사',
        charge: '내란중요임무종사·직권남용 (계엄사령관)',
        sentence: '징역 10년 (보석 취소·재구금)',
        prosecution: '징역 25년 (내란특검)',
        status: 'convicted',
        detail: '전 육군참모총장(계엄사령관), 포고령 제1호 발령·병력 투입 지휘. 2026.9.21 1심 (형사26부 이현경). 재판부: "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다". 선고와 함께 보석 취소·재구금.'
    },
    {
        date: '2026.06.22',
        defendant: '박성재',
    ...
    },
    {
        ...
        court: '서울중앙지법 형사합의26부',
        charge: '특수공무집행방해·직권남용·범인은닉',
        sentence: '징역 2년 6개월 (법정구속)',
        prosecution: '구형 징역 5년 (내란 특검)',
        status: 'convicted',
        detail: '전 대통령경호처 경호본부장. 박종준·김성훈과 공모해 경호처 직원·차벽으로 윤석열 체포영장 집행 저지. 2026.7.9 1심 징역 2년 6개월·법정구속(형사26부 이현경, 구형 5년).'
    },
    {
        date: '2026.07.09',
        defendant: '김신',
        ...
        prosecution: '구형 징역 3년 (내란 특검)',
        status: 'convicted',
        detail: '전 대통령경호처 가족부장. 경호처 4인 중 최말단. 2026.7.9 1심 징역 1년·집행유예 2년(형사26부 이현경, 구형 3년) — 4인 중 유일하게 법정구속되지 않음.'
    },
    {
        date: '2026.08.27',
        defendant: '김현태',
        ...
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사·직권남용 (707특임단장)',
        sentence: '징역 12년 (법정구속)',
        prosecution: '징역 18년 (내란특검, "내란 행동대장")',
        status: 'convicted',
        detail: '전 707특수임무단장(대령). 계엄의 밤 국회에 가장 먼저 도착해 "유리창을 깨고 본청에 진입하라" 지시. 2026.8.27 1심 (형사37-2부 오창섭). 재판부 "용납할 수 없는 범행". 선고 후에도 유튜브 등에서 계엄 정당성을 주장하며 법치에 저항해 온 점을 양형에 반영, 7명 중 유일하게 법정구속.'
    },
    {
        date: '2026.08.27',
        defendant: '이상현',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (1공수특전여단장)',
        sentence: '징역 10년',
        prosecution: '징역 15년 (내란특검)',
        status: 'convicted',
        detail: '전 특전사 제1공수특전여단장(준장). 병력을 이끌고 국회 봉쇄·침투 관여. 2026.8.27 1심 (형사37-2부 오창섭). 재판부 "용납할 수 없는 범행". '
    },
    {
        date: '2026.08.27',
        defendant: '김봉규',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (정보사 중앙신문단장)',
        sentence: '징역 7년',
        prosecution: '징역 12년 (내란특검)',
        status: 'convicted',
        detail: '전 정보사 중앙신문단장(대령). 노상원·문상호 지시로 정보사 요원 명단 준비, 선관위 직원 체포·구금 인력 편성. 2026.8.27 1심 (형사37-2부 오창섭). 재판부 "용납할 수 없는 범행". '
    },
    {
        date: '2026.08.27',
        defendant: '정성욱',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (정보사 100여단 제2사업단장)',
        sentence: '징역 7년',
        prosecution: '징역 12년 (내란특검)',
        status: 'convicted',
        detail: '전 정보사 100여단 제2사업단장(대령). 김봉규와 함께 선관위 직원 체포·구금 인력 편성. 2026.8.27 1심 (형사37-2부 오창섭). 재판부 "용납할 수 없는 범행". '
    },
    {
        date: '2026.08.27',
        defendant: '김대우',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (방첩사 방첩수사단장)',
        sentence: '징역 5년',
        prosecution: '징역 12년 (내란특검)',
        status: 'convicted',
        detail: '전 방첩사 방첩수사단장(준장). 방첩사 수사단 인력으로 정치인 체포조 운영 가담. 2026.8.27 1심 (형사37-2부 오창섭). 재판부 "용납할 수 없는 범행". 유죄 5명 중 최저형.'
    },
    {
        date: '2026.08.27',
        defendant: '박헌수',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (국방부 조사본부장)',
        sentence: '무죄',
        prosecution: '징역 10년 (내란특검)',
        status: 'acquitted',
        detail: '전 국방부 조사본부장(소장). 정치인 체포조 운영 가담 혐의. 2026.8.27 1심(형사37-2부 오창섭) — 내란의 고의가 인정되지 않는다며 무죄.'
    },
    {
        date: '2026.08.27',
        defendant: '고동희',
        court: '서울중앙지법 형사합의37-2부',
        judge: '오창섭 부장판사',
        charge: '내란중요임무종사 (정보사 계획처장)',
        sentence: '무죄',
        prosecution: '징역 10년 (내란특검)',
        status: 'acquitted',
        detail: '전 정보사 계획처장(대령). 선관위 청사 장악 관여 혐의. 2026.8.27 1심(형사37-2부 오창섭) — 내란의 고의가 인정되지 않는다며 무죄.'
    },
    {
        date: '2026.09.21',
        defendant: '여인형',
        ...
        charge: '내란중요임무종사 (형법 제87조)',
        sentence: '징역 18년',
        prosecution: '징역 30년 (내란특검)',
        status: 'convicted',
        detail: '전 국군방첩사령관, 방첩사 병력 투입·체포조 운영 지휘. 2026.9.21 1심 (형사26부 이현경). 재판부: "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다". 군 지휘관 5명 중 최고형. 일반이적(평양 무인기) 별건 1심 15년(6.12)과 별개.'
    },
    {
        date: '2026.09.21',
        defendant: '이진우',
        ...
        judge: '이현경 부장판사',
        charge: '내란중요임무종사 (형법 제87조)',
        sentence: '징역 15년 (보석 취소·재구금)',
        prosecution: '징역 30년 (내란특검)',
        status: 'convicted',
        detail: '전 수도방위사령관, 수방사 병력 국회 투입 지휘. 2026.9.21 1심 (형사26부 이현경). 재판부: "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다". 선고와 함께 보석 취소·재구금.'
    },
    {
        date: '',
        defendant: '윤석열',
    ...
    },
    {
        date: '2026.07.10',
        defendant: '김태효',
        court: '서울중앙지법 내란 전담 영장부',
        charge: '내란중요임무종사·직권남용권리행사방해',
        sentence: '',
        prosecution: '구속 (2026.7.10, "증거인멸 염려")',
        status: 'pending',
        detail: '전 국가안보실 1차장. 2026.7.10 서울중앙지법 내란 전담 영장부(부동식 부장판사)가 "증거인멸 염려"로 구속영장 발부 — 2차 종합특검(특별검사 권창영)이 7.7 청구. 12·3 계엄 직후 외무 공무원을 통해 미국 등 우방국에 계엄 정당화 메시지를 전달(필립 골드버그 당시 주한미국대사 설득)한 의혹. 같은 혐의로 입건된 신원식 전 안보실장은 가담 정도가 가볍다고 보고 영장 미청구.'
    },
    {
        date: '',
        defendant: '심우정',
    ...
    },
    {
        ...
        sentence: '징역 5년 (대법원 확정)',
        prosecution: '징역 5년 (민중기 특검)',
        status: 'convicted',
        detail: "'건진법사'(승려). 김건희와 공모, 통일교 윤영호로부터 샤넬백·그라프 다이아몬드 목걸이 등 8천여만원 금품 수수 알선. 1심 6년→2심 5년→2026.7.9 대법원 상고기각·징역 5년 확정(추징 약 1억8,078만원). 알선수재 유죄·정치자금법 무죄. 김건희 통일교 금품수수 첫 대법원 판단."
    },
    {
        date: '2026.07.09',
        defendant: '윤영호',
        court: '대법원 3부 (확정)',
        judge: '노경필 대법관(주심)',
        charge: '정치자금법·청탁금지법 위반, 업무상횡령',
        sentence: '징역 1년 6개월 (대법원 확정)',
        prosecution: '',
        status: 'convicted',
        detail: '전 통일교 세계본부장. 김건희와 공모한 통일교 청탁·금품수수, 2022.1 한학자 총재 지시로 권성동 의원에게 1억원 전달. 1심 1년 2개월→2심 1년 6개월→2026.7.9 대법원 상고기각 확정.'
    },
    {
        date: '',
        defendant: '정진석',
...
const DEFAULT_FIRST_COURTS = [
    ...
    },
    {
        ...
        chiefClass: 32,
        associates: [],
        mainCase: '군 지휘관 5인 내란(여인형·이진우·문상호·박안수·곽종근, 9.21 선고) · 경호처 윤석열 체포방해'
    },
    {
        division: '형사합의27부',
        chief: '우인성',
