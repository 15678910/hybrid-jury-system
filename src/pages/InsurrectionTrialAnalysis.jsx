...
const DEFAULT_VERDICTS = [
    ...
    },
    {
        ...
        judge: '조형우 부장판사',
        charge: '정치자금법 위반 (명태균 여론조사비 대납) ※내란과 무관한 별개 사건',
        sentence: '미선고 (공판 진행 중)',
        prosecution: '-',
        status: 'pending',
        detail: "'명태균 여론조사비 대납' 의혹 — 2021년 4·7 서울시장 보궐선거를 앞두고 명태균에게 여론조사를 부탁하고 후원자가 비용을 대납한 혐의. 강철원 전 정무부시장 등 공동 피고인. 2026.6.10 공판, 6.17 피고인 신문 후 6.3 지방선거 이후 선고 예정. 내란 사건이 아닌 정치자금법 위반 사건임."
    },
    {
        date: '2026.04.29',
        defendant: '윤석열',
