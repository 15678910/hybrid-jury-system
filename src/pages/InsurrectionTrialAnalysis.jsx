...
const DEFAULT_VERDICTS = [
    ...
    {
        date: '',
        defendant: '정진팔·김흥준·이재식',
        court: '권창영 종합특검',
        charge: '내란중요임무종사 (합참 수뇌부)',
        sentence: '',
        prosecution: '',
        status: 'pending',
        detail: '합참 차장·육군본부 정책실장·합참 전비태세검열차장. 12·3 당시 합참 지휘통제실에서 병력의 국회 투입을 파악하고도 제지하지 않고 계엄사령부 구성에 관여한 혐의. 6.15 구속, 6월 말 기소 방침. (김명수 전 합참의장은 영장 기각) ※군사반란이 아닌 형법상 내란중요임무종사로 의율.'
    },
    {
        date: '',
        defendant: '조성현',
