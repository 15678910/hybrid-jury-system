...
const DEFAULT_VERDICTS = [
    ...
    },
    {
        ...
        status: 'pending',
        detail: '전 대통령경호처장. 2025.1 공수처의 윤석열 체포영장 집행을 경호처 직원·차벽 동원으로 방해한 혐의. 2026.6.1 결심(구형 7년) → 2026.7.9 1심 선고(형사26부 이현경). ※ 별건 증거인멸 혐의는 2026.5.21 1심 무죄(형사32부 류경진).'
    },
    {
        date: '2026.07.09',
        defendant: '김성훈',
        ...
        prosecution: '구형 징역 7년 (내란 특검)',
        status: 'pending',
        detail: '전 대통령경호처 차장. 박종준 전 처장과 공모해 윤석열 체포영장 집행을 저지한 혐의. 2026.6.1 결심(구형 7년, 박종준과 동일) → 2026.7.9 1심 선고(형사26부 이현경).'
    },
    {
        date: '',
        defendant: '여인형',
