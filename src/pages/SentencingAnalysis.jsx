...
const personsData = {
    '강의구': {
        id: 'kanguigu',
        name: '강의구',
        position: '전 대통령실 부속실장 (1급 고위공무원)',
        status: '구속',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의30부',
        judge: '박옥희 부장판사',
        verdictDate: '2026년 5월 28일',
        charges: [
            {
                id: 1,
                name: '허위공문서작성',
                law: '형법 제227조',
                description: '비상계엄 선포문에 대통령 서명·국무위원 부서가 누락된 하자를 인지한 후 은폐 위해 사후적으로 표지를 새로 작성',
                prosecutionRequest: '징역 5년 (전체 구형)',
                verdict: '유죄',
                reason: '"피고인은 대통령을 지근거리에서 보좌하는 1급 고위공무원인 부속실장임에도 하자를 인지 후 은폐 위해 당초 배포된 선포문에 없던 표지를 새로 작성, 죄책이 무겁다"'
            },
            {
                id: 2,
                name: '공용서류손상',
                law: '형법 제141조',
                description: '한덕수 전 국무총리로부터 사후 계엄선포문 폐기 요청을 받고 윤석열 전 대통령에게 보고한 뒤 대통령기록물이자 공용서류를 무단 폐기',
                prosecutionRequest: '징역 5년 (전체 구형)',
                verdict: '유죄',
                reason: '폐기 요청을 보고 후 무단 폐기, 범행의 주요 실행행위 담당'
            },
            {
                id: 3,
                name: '대통령기록물법 위반',
                law: '대통령기록물법',
                description: '대통령기록물에 해당하는 사후 계엄선포문(원본)을 무단 폐기',
                prosecutionRequest: '징역 5년 (전체 구형)',
                verdict: '유죄',
                reason: '대통령기록물 무단 폐기 인정'
            }
        ],
        summary: {
            prosecutionTotal: '징역 5년 (특검 구형)',
            verdictTotal: '징역 1년 6개월, 법정구속',
            ratio: '구형의 약 30%'
        },
        keyFacts: [
            '12·3 비상계엄 사후 계엄선포문(표지) 작성·폐기 혐의로 기소',
            '비상계엄 선포가 대통령 서명·국무위원 부서가 담긴 문서로 이뤄지지 않은 하자를 사후 은폐',
            '한덕수 전 국무총리의 폐기 요청 → 윤석열 전 대통령에게 보고 → 대통령기록물 무단 폐기 흐름',
            '윤석열 등 사전지시 없이도 계엄선포문 표지 형식 작성·서명을 받는 등 범행의 주요 실행행위 담당 (재판부 판시)',
            '특검 구형 5년 → 1심 1년 6개월·법정구속 (구형 약 30% 수준)',
            '같은 날(2026.05.28) 형사합의32부(류경진)가 윤석열 위증 사건을 무죄 선고한 것과 정반대 결과',
            '한덕수(형사33부 23년)·이상민(형사32부 7년)에 이어 12·3 비상계엄 내란 사건군 4번째 1심 실형'
        ],
        trialStatus: '1심 선고 완료 (2026.05.28 법정구속)',
        sentencingGuidelines: [
            {
                crime: '허위공문서작성 (형법 제227조)',
                standardRange: '7년 이하 징역 또는 2천만원 이하 벌금',
                aggravating: ['1급 고위공무원 부속실장 지위', '비상계엄 문서 하자 은폐 목적', '대통령을 지근거리에서 보좌하는 직위의 신뢰 배반'],
                mitigating: ['대체로 사실관계 인정', '자신의 이익을 위해 작성한 것으로 보이지 않음', '수사기관에 사실대로 진술'],
                verdict: '유죄 - 징역 1년 6개월(공용서류손상·대통령기록물법 위반 포함)',
                analysis: '재판부는 죄책이 무겁다고 명시하면서도 사실관계 인정 등을 유리한 정상으로 참작, 구형의 약 30% 수준 선고'
            },
            {
                crime: '공용서류손상 (형법 제141조)',
                standardRange: '7년 이하 징역 또는 1천만원 이하 벌금',
                aggravating: ['대통령기록물 동시 손상', '비상계엄 관련 핵심 문서 폐기'],
                mitigating: ['한덕수 총리의 폐기 요청에 따른 행위라는 점'],
                verdict: '유죄',
                analysis: '폐기 요청을 윤석열에게 보고 후 실제로 무단 폐기한 점에서 실행행위 인정'
            }
        ],
        judgeHistory: {
            judgeName: '박옥희',
            position: '서울중앙지방법원 형사합의30부 부장판사',
            recentCases: [
                {
                    year: '2026',
                    caseName: '강의구 사후 계엄선포문 작성·폐기 사건',
                    role: '재판장',
                    verdict: '유죄 - 징역 1년 6개월, 법정구속'
                }
            ],
            profile: '서울중앙지방법원 형사합의30부 재판장. 12·3 비상계엄 사후 계엄선포문 사건 1심에서 "1급 고위공무원의 죄책이 무겁다"며 법정구속'
        },
        keyIssues: [
            {
                title: '구형 5년 vs 선고 1년 6개월 (구형 30%) - 양형 적정성 논란',
                description: '특검은 비상계엄 선포라는 헌법 질서 교란의 사후 은폐 행위의 중대성을 들어 5년을 구형했으나, 재판부는 1년 6개월을 선고하여 구형의 약 30% 수준에 그침. 한덕수(형사33부, 구형 15년→선고 23년, 153%)와 비교 시 양형 격차가 큼.',
                opinion: {
                    prosecution: '비상계엄 문서 하자 사후 은폐의 헌정 파괴적 성격을 감안한 5년 구형',
                    defense: '사실관계 인정, 본인 이익 아님, 수사기관 협조 등 유리한 정상 참작 요청',
                    court: '"죄책이 무겁다"고 명시하면서도 자백·협조를 들어 1년 6개월 선고·법정구속'
                }
            },
            {
                title: '같은 날 형사32부 윤석열 위증 무죄와의 극명한 대비',
                description: '2026.05.28 같은 날 같은 서울중앙지법에서 형사합의32부(류경진)는 윤석열 한덕수 재판 위증 사건을 무죄로 선고. 형사30부는 강의구를 법정구속한 반면 형사32부는 윤석열을 면책하여, 동일 12·3 비상계엄 사건군 내 재판부 간 사실 판단·양형 격차가 극명하게 드러남.',
                opinion: {
                    prosecution: '내란 핵심 사실관계의 사후 은폐는 헌정 질서 훼손',
                    defense: '단순 표지 작성 행위이며 본인 이익 무관',
                    court: '"피고인이 범행의 주요 실행행위 담당" → 실형 법정구속'
                }
            },
            {
                title: '윤석열·한덕수 본안 재판에 미치는 영향',
                description: '재판부가 "윤석열 등 사전지시 없이도 강의구가 표지 형식 작성·서명을 받는 등 범행의 주요 실행행위 담당"이라고 판시한 점은, 비상계엄 문서 자체의 절차적 하자(대통령 서명·국무위원 부서 누락)를 법원이 공식 인정한 것. 본안 내란 재판에서 비상계엄 선포의 위법성 판단에 선례적 영향.',
                opinion: {
                    prosecution: '문서 하자 인정 → 비상계엄 절차 위법성의 법원 첫 공식 인정',
                    defense: '문서 작성 시점·경위와 본안 내란 성립은 별개',
                    court: '대통령 서명·국무위원 부서 누락이라는 "하자"를 명시'
                }
            },
            {
                title: '내란 가담자 4번째 1심 실형 - 패턴 형성',
                description: '한덕수(23년), 이상민(7년), 박종준(무죄), 조태용(주요혐의 무죄, 위증 1년6월)에 이어 강의구(1년6월) 4번째 1심 실형. 다만 다른 재판부(형사30부)에서 나온 판결로, 같은 법원·같은 사건군 내 재판부별 판단 편차가 사법 일관성 시험대.',
                opinion: {
                    prosecution: '내란 가담자 처벌 의지 표명',
                    defense: '실행 정도에 비해 양형 과중',
                    court: '실행행위 담당 인정, 다만 자백·협조로 감경'
                }
            }
        ]
    },
    '곽종근': {
        ...
        name: '곽종근',
        position: '전 육군특수전사령관',
        status: '구속 (보석 취소·재구금, 1심 징역 9년)',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의26부',
        judge: '이현경 부장판사',
        verdictDate: '2026년 9월 21일 (1심)',
        charges: [
            {
                id: 1,
                name: '내란중요임무종사',
                ...
                prosecutionRequest: '징역 20년 (내란특검 구형)',
                verdict: '유죄 — 징역 9년 (2026.9.21 1심, 형사합의26부)',
                reason: '재판부(이현경): "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다" — 특전사 병력의 국회 투입 지휘를 내란 중요임무 종사로 인정. 함께 선고된 군 지휘관 5명 중 가장 낮은 형(구형 20년의 45%)'
            }
        ],
        summary: {
            prosecutionTotal: '징역 20년 (내란특검 구형)',
            verdictTotal: '징역 9년 (1심, 2026.9.21)',
            ratio: '구형 20년 → 선고 9년 (45%)'
        },
        keyFacts: [
            ...
            '2026.9.21 1심 징역 9년 (서울중앙지법 형사합의26부 이현경, 구형 20년) — 여인형 18년·이진우 15년·문상호 12년·박안수 10년과 함께 선고, 5명 중 최저형',
            '선고와 함께 보석 취소 → 재구금'
        ],
        trialStatus: '1심 징역 9년 선고 (2026.9.21, 형사합의26부) — 보석 취소·재구금, 항소 여부 미확인',
        judgeHistory: {
            judgeName: '이현경',
            position: '서울중앙지방법원 형사합의26부 부장판사',
            recentCases: [
                { year: '2026', caseName: '군 지휘관 5인 내란중요임무종사 사건 (여인형·이진우·문상호·박안수·곽종근)', role: '재판장', verdict: '유죄 - 징역 18년·15년·12년·10년·9년 (2026.9.21, 구형 30·30·20·25·20년)' },
                { year: '2026', caseName: '대통령경호처 윤석열 체포영장 집행 방해 사건 (박종준·김성훈·이광우·김신)', role: '재판장', verdict: '유죄 - 징역 4년·5년·2년 6개월(법정구속)·1년 집유 2년 (2026.7.9)' }
            ],
            profile: '서울중앙지방법원 형사합의26부 재판장. 2026.9.21 군 지휘관 5인 내란중요임무종사 1심에서 "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다"며 전원 실형(구형의 40~60%). 보석 중이던 이진우·박안수·곽종근은 보석 취소·재구금'
        }
    },
    '강동길': {
        id: 'kangdonggil',
    ...
    '정진팔': {
        ...
        keyFacts: [
            ...
            '※현재 죄명은 형법상 내란중요임무종사 (특검은 윤석열 등에 군형법상 반란죄 적용 확대 검토 중)'
        ],
    ...
    '조성현': {
        ...
        keyFacts: [
            ...
            '다음 달 초 소환조사 예정',
            '※현재 죄명은 형법상 내란중요임무종사이나, 특검은 12·3 군 지휘관들에 대한 군형법상 반란죄 적용 확대도 검토 중'
        ],
    ...
    '김건희': {
        ...
        judge: '우인성 부장판사 (도이치 1심) · 신종오 (도이치 항소심) · 조순표 (매관매직 1심) · 성언주 (매관매직 항소심)',
        verdictDate: '2026년 4월 28일 (도이치 항소심) · 2026년 9월 22일 (매관매직 항소심)',
        appealVerdict: {
            date: '2026.04.28',
            court: '서울고법 형사15-2부',
        ...
        matters: [
            ...
            { key: 'maegwan', label: '조순표·성언주 재판부', sub: "'매관매직' 알선수재 (이봉관 서희건설)", judgeId: 'jo-sunpyo', court: '서울중앙지법 형사합의21부(1심 조순표) · 서울고법 형사15-3부(항소심 성언주)', prosecution: '징역 7년 6개월 (특검, 1심 구형)', verdict: '항소심 징역 5년 (1심 7년→2년 감형, 2026.9.22 서울고법 형사15-3부 성언주) — 바쉐론 시계·세한도 복제본 무죄, 반클리프 목걸이·귀걸이·금거북이·이우환 그림·디올백 유죄 유지, 이우환 그림·반클리프 목걸이·디올 파우치 몰수, 추징 2,440만원', chargeIds: [5], guidelineCrimes: ["'매관매직' 알선수재 (특정범죄가중처벌법) — 별개 1심"] }
        ],
        bribeGivers: [
            ...
            { matter: 'maegwan', name: '김상민', role: '전 부장검사', charge: '청탁금지법·정치자금법 위반', gave: '이우환 그림 1억4,000만원 상당(2023.2 김건희 측에 전달, 22대 총선 공천 청탁) + 선거차량 리스 등 4,200만원 불법 정치자금', result: '1심 정치자금법만 유죄(징역 6개월·집유 1년) → 2심 청탁금지법(그림 청탁)도 유죄로 뒤집힘 → 대법원 3부(주심 이흥구) 2026.7.23 상고 기각·유죄 확정: 청탁금지법 징역 2년·집유 3년 + 정치자금법 징역 1년·집유 3년·추징 4,139만원', source: { name: '파이낸셜뉴스', url: 'https://www.fnnews.com/news/202607231129031423' } },
        ...
        charges: [
            ...
            {
                id: 5,
                name: "[별개] '매관매직' 알선수재 (이봉관 서희건설) — 1심 7년 → 항소심 5년",
                law: '특정범죄가중처벌법 위반 (알선수재)',
                period: '2022 (청탁 시점)',
                amount: '반클리프 목걸이·귀걸이 1억380만원 + 금거북이 265만원 + 바쉐론 시계 3,990만원 + 이우환 그림 1억4,000만원 + 디올백 등',
                prosecutionRequest: '징역 7년 6개월 (특검, 1심)',
                verdict: '1심 징역 7년(세부 5건 전부 유죄, 2026.6.26) → 항소심 징역 5년 (2026.9.22, 서울고법 형사15-3부 성언주): 바쉐론 시계·세한도 복제본 무죄, 나머지 유죄 유지·몰수, 추징 2,440만원',
                appealChange: '2년 감형 (7년 → 5년)',
                appealDetail: '서울고법 형사15-3부(성언주): 세한도 복제본은 "한지 살리기 홍보사업의 일환으로 전달됐을 가능성을 배제하기 어렵다", 바쉐론 콘스탄틴 시계는 묵시적 청탁을 인정하기 어렵다며 무죄. 반클리프 목걸이·귀걸이, 금거북이, 이우환 그림(1억4,000만원), 디올백 등은 유죄 유지. 이우환 그림·반클리프 목걸이·디올 파우치 몰수, 2,440만원 추징. 김건희 측 "양형이 실질적 책임 정도에 비춰 과중" — 상고 방침',
                reason: '항소심(성언주): "대통령 배우자로서 영향력을 행사한다는 걸 알 수 있었음에도 자신의 지위를 망각한 채 아무런 거리낌 없이 반복해 금품을 수수했다" / 1심: 서울중앙지법 형사합의21부(조순표 부장판사)는 사위 박성근 변호사 공직 임명·국가교육위원장 임명·로봇개 사업 지원·총선 공천 청탁 명목의 금품 수수 5건을 전부 유죄로 인정하고 "위법성을 인식하고도 은폐"했다고 판단, 징역 7년 선고(2026.6.26, 생중계). 도이치·통일교 사건(항소심 4년)과 별개의 1심 판결.'
            }
        ],
        summary: {
            prosecutionTotal: '징역 15년, 벌금 20억원, 추징금 9억 4,800만원 + 윤석열 공직선거법·정치자금법 위반 별도 기소',
            verdictTotal: '도이치·통일교 항소심 징역 4년 (1심 1년 8개월에서 가중), 벌금 5,000만원, 추징금 2,094만원 · [별개] 매관매직 항소심 징역 5년 (2026.9.22, 1심 7년→감형)',
        ...
        keyFacts: [
            ...
            "[별개 사건] '매관매직' 알선수재 — 1심 징역 7년 (2026.6.26, 서울중앙지법 형사합의21부 조순표) → 항소심 징역 5년 (2026.9.22, 서울고법 형사15-3부 성언주: 바쉐론 시계·세한도 복제본 무죄로 2년 감형, 이우환 그림·반클리프 목걸이·디올 파우치 몰수·2,440만원 추징, 김건희 측 상고 방침). 1심 요지: 이봉관 서희건설 회장에게 공직 임명·국가교육위원장·공천 청탁 명목 반클리프·금거북이·바쉐론 시계·이우환 그림·디올백 등 수수, 세부 5개 혐의 전부 유죄 (특검 구형 7년 6개월)"
        ],
        trialStatus: "도이치·통일교 사건 항소심 선고 완료(2026.04.28 징역 4년) — 상고심 진행 가능. ※별개 '매관매직'(이봉관 서희건설) 알선수재: 1심 2026.6.26 징역 7년(서울중앙지법 형사합의21부 조순표, 5건 전부 유죄) → 항소심 2026.9.22 징역 5년(서울고법 형사15-3부 성언주, 시계·세한도 무죄로 2년 감형) — 상고심 예정",
        sentencingGuidelines: [
            {
                crime: '주가조작 (자본시장법 위반)',
                standardRange: '3년~5년',
            ...
            {
                crime: "'매관매직' 알선수재 (특정범죄가중처벌법) — 별개 1심",
                standardRange: '징역 3년~7년 (알선수재)',
                aggravating: ['대통령 배우자 지위를 이용한 반복적 청탁 알선', '공직 임명·공천 등 국정 사유화', '귀금속·명품·미술품 등 고액 금품 수수', '위법성을 인식하고도 은폐'],
                mitigating: ['형사 처벌 전력 없음'],
                verdict: '1심 징역 7년 → 항소심 징역 5년 (2026.9.22, 2년 감형)',
                analysis: '항소심(서울고법 형사15-3부 성언주)은 바쉐론 시계·세한도 복제본을 무죄로 뒤집어 징역 5년으로 감형했으나 "지위를 망각한 채 아무런 거리낌 없이 반복해 금품을 수수했다"며 나머지 유죄와 몰수를 유지. / 1심: 서울중앙지법 형사합의21부(조순표)는 세부 5개 혐의를 전부 유죄로 인정하고 권고형 상한에 해당하는 징역 7년(특검 구형 7년 6개월)을 선고. 도이치·통일교 사건과 별개의 1심으로, 봐주기 없는 엄정한 양형으로 평가된다.'
            },
            {
        ...
        keyIssues: [
            {
                matter: 'maegwan',
                title: '항소심 2년 감형(7년→5년) — 바쉐론 시계·세한도 복제본 무죄, 나머지 유죄 유지 (2026.9.22)',
                description: '서울고법 형사15-3부(성언주)는 1심이 유죄로 본 5건 가운데 바쉐론 콘스탄틴 시계(묵시적 청탁 인정 곤란)와 세한도 복제본("한지 살리기 홍보사업의 일환으로 전달됐을 가능성")을 무죄로 뒤집고 징역 5년을 선고했다. 반클리프 목걸이·귀걸이, 금거북이, 이우환 그림, 디올백 등은 유죄를 유지했고 이우환 그림·반클리프 목걸이·디올 파우치를 몰수, 2,440만원을 추징했다. 재판부는 "대통령 배우자로서 영향력을 행사한다는 걸 알 수 있었음에도 자신의 지위를 망각한 채 아무런 거리낌 없이 반복해 금품을 수수했다"고 했다. 김건희 측은 상고 방침을 밝혔다.',
                opinion: {
                    prosecution: '특검 1심 구형 징역 7년 6개월. 항소심 선고에 대한 특검의 상고 여부는 확인되지 않음',
                    defense: '변호인단: "항소심의 양형이 실질적 책임 정도에 비춰 과중하다" — 상고 방침',
                    court: '"대통령 배우자로서 영향력을 행사한다는 걸 알 수 있었음에도 자신의 지위를 망각한 채 아무런 거리낌 없이 반복해 금품을 수수했다" — 다만 시계·세한도 복제본 2건은 대가성·청탁 인정 부족으로 무죄, 형량 2년 감경'
                }
            },
            {
                matter: 'maegwan',
    ...
    '김용현': {
        ...
        charges: [
            ...
            },
            {
                ...
                name: '일반이적 (평양 무인기)',
                law: '형법 제93조',
                description: '2024년 평양 무인기 침투 작전 — 비상계엄 명분 조성. 2025.11.10 기소',
                prosecutionRequest: '징역 30년 (특검 구형)',
                verdict: '1심 징역 30년 (2026.06.12)',
                reason: '서울중앙지법 형사합의36부(이정엽 부장판사): 국방부 장관으로서 무인기 작전을 지시·주도, 윤석열과 일반이적 공동정범 인정. (2026.2.19 본안 내란 30년과 별개 사건)'
            },
            {
                id: 4,
                name: '군기누설·개인정보보호법 위반 (정보사 명단 누설)',
                law: '군형법·개인정보보호법',
                description: '2024.10~11 문상호 정보사령관 등과 공모해 정보사 특수임무대(HID) 요원 약 40명의 명단을 노상원 전 정보사령관에게 전달. 비상계엄 시 부정선거 의혹을 수사할 \'제2수사단\' 구성 목적',
                prosecutionRequest: '징역 5년 (특검 구형)',
                verdict: '1심 징역 3년 (2026.06.19 선고)',
                reason: '서울중앙지법 형사합의21부(조순표 부장판사): "위헌·위법한 비상계엄이 선포에 이를 수 있게 한 동력 — 단순 군기누설·개인정보보호법 위반을 넘어선 중대한 결과". 2.19 내란 30년과 별건, 변호인 항소 예고'
            }
        ],
        summary: {
            prosecutionTotal: '무기징역 (특검 구형)',
            verdictTotal: '내란 30년(2.19) · 평양무인기 30년(6.12) · 정보사 명단누설 3년(6.19)',
            ratio: '무기징역→30년 (감경)'
        },
        keyFacts: [
            ...
            '2026.6.12 평양 무인기 일반이적 1심: 징역 30년 (형사36부 이정엽, 본안 내란과 별건)',
            '2026.6.19 정보사 HID 요원 명단 누설(군기누설·개인정보보호법) 1심: 징역 3년 (형사21부 조순표, 특검 구형 5년) — 부정선거 수사 제2수사단 구성 목적'
        ],
        verdictDate: '2026년 2월 19일',
        trialStatus: '1심: 내란중요임무종사 30년(2.19)·평양무인기 30년(6.12)·정보사 명단누설 3년(6.19)',
        sentencingGuidelines: [
            {
        ...
        charges: [
            {
                ...
                prosecutionRequest: '징역 20년 (내란특검 구형)',
                verdict: '유죄 — 징역 12년 (직권남용과 병합, 2026.9.21 1심)',
                reason: '재판부(이현경): "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다" — 정보사 병력의 선관위 투입 지휘를 내란 중요임무 종사로 인정 (구형 20년의 60%)'
            },
            {
                id: 2,
                name: '직권남용권리행사방해',
                ...
                verdict: '유죄 (내란죄와 병합 징역 12년, 2026.9.21)',
                reason: '선관위 서버실 침입 지시 등 직권남용 인정'
            },
            {
                id: 3,
                name: '군사기밀 누설',
                ...
                prosecutionRequest: '병합 구형',
                verdict: '무죄 (2026.9.21 1심)',
                reason: '재판부: 군사기밀 누설의 고의를 인정하기 어렵다 (뉴스1)'
            }
        ],
        summary: {
            prosecutionTotal: '징역 20년 (내란특검 구형)',
            verdictTotal: '징역 12년 (1심, 2026.9.21) · 군사기밀 누설 무죄',
            ratio: '구형 20년 → 선고 12년 (60%)'
        },
        keyFacts: [
            ...
            '2026.1.2 국방부 파면 처분',
            '2026.9.21 1심 징역 12년 (서울중앙지법 형사합의26부 이현경, 구형 20년) — 군사기밀 누설 혐의는 무죄',
            '별건 구속 상태 유지 (여인형과 함께)'
        ],
        trialStatus: '1심 징역 12년 선고 (2026.9.21, 형사합의26부) — 군사기밀 누설 무죄, 항소 여부 미확인',
        judgeHistory: {
            judgeName: '이현경',
            position: '서울중앙지방법원 형사합의26부 부장판사',
            recentCases: [
        ...
        charges: [
            {
                ...
                prosecutionRequest: '징역 25년 (내란특검 구형)',
                verdict: '유죄 — 징역 10년 (직권남용과 병합, 2026.9.21 1심)',
                reason: '재판부(이현경): "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다" — 계엄사령관으로서 포고령 발령·병력 투입 지휘를 내란 중요임무 종사로 인정 (구형 25년의 40%)'
            },
            {
                id: 2,
                name: '직권남용권리행사방해',
                ...
                prosecutionRequest: '징역 25년에 포함 (병합 구형)',
                verdict: '유죄 (내란죄와 병합 징역 10년, 2026.9.21)',
                reason: '위헌적 포고령 제1호 서명·발령 — 직권남용 인정'
            }
        ],
        summary: {
            prosecutionTotal: '징역 25년 (내란특검 구형)',
            verdictTotal: '징역 10년 (1심, 2026.9.21)',
            ratio: '구형 25년 → 선고 10년 (40%)'
        },
        keyFacts: [
            ...
            '전역 후 대전지방법원 논산지원에서 재판 진행 → 1심 선고는 서울중앙지법 형사합의26부에서 군 지휘관 4명과 함께 (2026.9.21)',
            '2026.9.21 1심 징역 10년 (형사합의26부 이현경, 구형 25년) — 선고와 함께 보석 취소·재구금'
        ],
        trialStatus: '1심 징역 10년 선고 (2026.9.21, 서울중앙지법 형사합의26부) — 보석 취소·재구금, 항소 여부 미확인',
        judgeHistory: {
            judgeName: '이현경',
            position: '서울중앙지방법원 형사합의26부 부장판사',
            recentCases: [
    ...
    '박성재': {
        ...
        name: '박성재',
        position: '법무부 장관',
        status: '법정구속 (1심 징역 25년)',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의33부',
        verdictDate: '2026년 6월 22일 (1심)',
        charges: [
            {
                id: 1,
                name: '내란중요임무종사',
                ...
                verdict: '유죄 — 징역 25년 (직권남용과 병합, 2026.6.22)',
                reason: '재판부(이진관): "계엄 선포 이후 출국금지 요원 대기, 교정시설 수용공간 확보, 합동수사본부 검사 파견 준비 등을 지시한 것은 윤석열의 지시사항을 그대로 이행한 것 — 내란의 중요 임무를 실행했다"며 유죄. 특검 구형(20년)보다 5년 무거운 25년 선고.'
            },
            {
                id: 2,
                name: '직권남용권리행사방해',
                ...
                prosecutionRequest: '징역 20년에 포함 (병합 구형)',
                verdict: '유죄 (내란죄와 병합 징역 25년, 2026.6.22)',
                reason: '비상계엄 선포 직후 교정본부에 구치소 수용 여력 파악 지시 등 — 반대세력 검거·구금 준비 행위로 인정.'
            },
            {
                id: 3,
                ...
                reason: '재판부: 김건희 수사 청탁 관련 혐의는 "내란 특검법상 수사 대상에 해당하지 않는다"며 공소기각(본안 판단 없이 종결).'
            }
        ],
        summary: {
            prosecutionTotal: '징역 20년 (내란중요임무종사·직권남용·청탁금지법 병합 구형, 2026.4.27)',
            verdictTotal: '징역 25년 + 법정구속 (1심, 2026.6.22) — 구형 20년보다 5년 가중, 청탁금지법은 공소기각',
            ratio: '구형 20년 → 선고 25년 (125%)'
        },
        keyFacts: [
            '비상계엄 당시 법무부 장관, 내란중요임무종사·직권남용·청탁금지법 위반 혐의 기소 (2025.12.11)',
            '1심 선고: 2026.6.22 징역 25년·법정구속 (서울중앙지법 형사합의33부 이진관) — 내란중요임무종사·직권남용 유죄, 특검 구형(20년)보다 5년 가중',
            '재판부: 합수본 검사 파견 준비·교정시설 수용공간 확보·출국금지 요원 대기 등은 "윤석열 지시사항을 그대로 이행" → 내란 중요 임무 실행 인정',
            '김건희 수사 청탁 관련 혐의는 내란 특검 수사범위가 아니라며 공소기각',
            '증거인멸 우려로 법정구속',
        ...
        keyIssues: [
            {
                ...
                opinion: {
                    ...
                    court: '유죄 — 구치소 수용 여력 파악·검사 파견 준비 등을 적극 가담의 증거로 인정 (내란중요임무종사·직권남용 유죄, 징역 25년)'
                }
            },
            {
            ...
            },
            {
                ...
                opinion: {
                    ...
                    court: '공소기각 — 내란 특검법상 수사 대상이 아니라는 이유'
                }
            }
        ]
    },
    '박종준': {
        ...
        status: '법정구속',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의26부 (체포방해) / 형사합의32부 (증거인멸)',
        judge: '이현경 부장판사 (체포방해) / 류경진 부장판사 (증거인멸)',
        verdictDate: '2026년 7월 9일 (체포방해 1심)',
        charges: [
            {
                id: 1,
                name: '특수공무집행방해·직권남용·범인은닉',
                law: '형법 제144조·제123조·제151조',
                description: '2024.12.31 윤석열 체포영장 발부 후 박종준이 윤석열 지시로 2024.12.31~2025.01.02 처장 관저 1층 회의실에서 회의를 주재, 경호처 직원들에게 "공수처 체포영장은 위법"이라며 영장 집행 방해 명령. 2025.01.03 공수처 공무원이 영장 집행 시도 시 경호처 직원들로 하여금 유형력을 행사하게 함, 차벽 설치 등 (2025.12.04 내란 특검 기소)',
                prosecutionRequest: '특검 구형 징역 7년 (2026.06.01 결심공판)',
                verdict: '1심 징역 4년, 법정구속 (2026.7.9, 서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '2026.7.9 선고 — 박종준 징역 4년(법정구속), 김성훈 5년(법정구속), 이광우 2년 6개월(법정구속), 김신(전 가족부장) 1년·집행유예 2년. 재판부(형사26부 이현경): "피고인들의 범행은 경호처라는 국가기관의 조직·지휘·체계를 이용해 영장 집행을 장기간 차단한 중대한 범죄", "위법한 지시는 거부했어야 한다". 선고 4년은 구형 7년의 약 57%. 박종준은 별건 증거인멸 혐의로는 2026.5.21 1심 무죄(형사32부 류경진)'
            },
            {
                id: 2,
                name: '증거인멸',
                law: '형법 제155조',
                description: '윤석열·홍장원 비화폰 정보 원격삭제 관여 혐의 (2025.12.9 추가 기소)',
                prosecutionRequest: '특검 구형 (조사 중)',
                verdict: '1심 무죄 (2026.05.21)',
                reason: '재판부(형사32부 류경진): ① "조지호 전 경찰청장 등 다른 인물의 비화폰은 삭제하지 않아 인멸 고의 단정 어려움", ② "홍장원이 국회에서 비화폰 통화내역 사진을 공개한 이후 발생한 보안사고에 따른 조치로 볼 가능성", ③ "전자정보 삭제만으로 증거인멸 단정 어려움", ④ "사후적으로 부적절·미흡하더라도 인멸 추정 불가" — 매뉴얼에 따른 보안조치 성격으로 판단'
            }
        ],
        summary: {
            prosecutionTotal: '특수공무집행방해·직권남용·범인은닉: 특검 구형 징역 7년 (2026.06.01 결심) / 증거인멸: 특검 구형',
            verdictTotal: '체포방해 1심 징역 4년·법정구속 (2026.7.9, 형사26부 이현경) / 증거인멸 1심 무죄 (2026.05.21, 형사32부 류경진)',
            ratio: '체포방해 징역 4년 (구형 7년의 약 57%) / 증거인멸 무죄'
        },
        keyFacts: [
            '대통령경호처장으로서 공수처의 대통령 체포영장 집행 방해 혐의로 2025.12.04 내란 특검 기소 (특수공무집행방해·직권남용·범인은닉)',
            '2024.12.31~2025.01.02 처장 관저 1층 회의실에서 회의 주재, "공수처 체포영장 위법"이라며 영장 집행 방해 명령 (윤석열 지시)',
            '2025.01.03 공수처 공무원에 대해 경호처 직원들이 유형력 행사, 차벽 설치 등으로 영장 집행 무산',
            '2026.06.01 결심공판(구형 박7·김7·이5·김신3년) → 2026.7.9 1심 선고: 박종준 징역 4년·법정구속, 김성훈 5년·법정구속, 이광우 2년6개월·법정구속, 김신 1년·집유 2년 (형사26부 이현경)',
            '12·3 비상계엄 직후 윤석열·홍장원 비화폰 정보 원격삭제 관여 → 증거인멸 추가 기소 (2025.12.9)',
            '2026.05.21 증거인멸 1심 무죄 선고 (서울중앙지법 형사합의32부, 류경진 부장판사) — 같은 날 조태용 전 국정원장 주요 혐의 무죄와 동시 선고',
            '재판부(형사32부): "보안조치, 증거인멸로 단정 못해" "조지호 등 다른 사람 비화폰 미삭제로 인멸 고의 단정 어려움"',
            '같은 형사32부 류경진 재판부의 이상민(7년, 구형 47%)→박종준 증거인멸(무죄)→조태용(주요혐의 무죄)→윤석열(위증 무죄) 4연속 무죄·관대 선고 패턴의 두 번째 사례'
        ],
        trialStatus: '체포방해 1심 징역 4년·법정구속 (2026.7.9, 형사26부 이현경, 구형 7년) / 증거인멸 1심 무죄 (특검 상고 검토)',
        sources: [
            { label: '머니투데이', title: "'윤석열 체포 방해' 박종준 전 경호처장, 1심 징역 4년·법정 구속", url: 'https://www.mt.co.kr/society/2026/07/09/2026070913394097447', date: '2026.7.9' },
            { label: '한국일보', title: "'尹 체포 저지' 김성훈 징역 5년·박종준 징역 4년…법정 구속", url: 'https://www.hankookilbo.com/news/article/A2026070914350004154', date: '2026.7.9' },
            { label: '오마이뉴스', title: "'윤석열 체포방해' 박종준 전 경호처장 징역 4년 법정구속", url: 'https://www.ohmynews.com/NWS_Web/View/at_pg.aspx?CNTN_CD=A0003250108', date: '2026.7.9' }
        ]
    },
    '김성훈': {
        id: 'kimseonghun',
        name: '김성훈',
        position: '전 대통령경호처 차장',
        status: '법정구속',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의26부',
        judge: '이현경 부장판사',
        ...
        charges: [
            {
                ...
                name: '특수공무집행방해·직권남용·범인은닉',
                law: '형법 제144조·제123조·제151조',
                description: '박종준 전 처장과 공모하여 2024.12.31~2025.01.02 처장 관저 회의에서 영장 집행 방해 방침 결정, 경호처 직원들로 하여금 공수처의 윤석열 체포영장 집행을 유형력으로 저지하게 한 혐의 (2025.12.04 내란 특검 기소)',
                prosecutionRequest: '특검 구형 징역 7년 (2026.06.01 결심공판)',
                verdict: '1심 징역 5년, 법정구속 (2026.7.9, 서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '2026.7.9 선고 — 김성훈 징역 5년·법정구속. 같은 구형 7년이지만 박종준(4년)보다 1년 무거운 형. 재판부(형사26부 이현경): "경호처라는 국가기관의 조직·지휘·체계를 이용해 영장 집행을 장기간 차단한 중대한 범죄". 별건 비화폰 기록 삭제 직권남용은 진행 중'
            },
            {
                id: 2,
                name: '직권남용권리행사방해 (대통령경호법)',
                law: '대통령경호법·형법 제123조',
                description: '12·3 비상계엄 직후 군 지휘부의 비화폰 기록 삭제 지시 (2025.12.4 또는 이후 추가 기소)',
                prosecutionRequest: '병합 기소',
                verdict: '재판 진행 중',
                reason: '대통령경호처 차장의 직권 범위를 벗어나 군 지휘부 비화폰 기록 삭제를 지시한 혐의'
            }
        ],
        summary: {
            prosecutionTotal: '특수공무집행방해·직권남용·범인은닉: 특검 구형 징역 7년 (2026.06.01 결심) / 비화폰 기록 삭제 직권남용: 별도 진행 중',
            verdictTotal: '체포방해 1심 징역 5년·법정구속 (2026.7.9, 형사26부 이현경) / 비화폰 삭제 직권남용 별도 진행 중',
            ratio: '체포방해 징역 5년 (구형 7년의 약 71%, 박종준 4년보다 무거움)'
        },
        keyFacts: [
            '전 대통령경호처 차장. 2024.12.31 윤석열 체포영장 발부 후 박종준 전 처장과 공모하여 영장 집행 저지 결정',
            '경호처 직원 동원하여 2025.01.03 공수처 1차 체포영장 집행 무산시킨 핵심 인물 중 한 명',
            '12·3 비상계엄 직후 군 지휘부 비화폰 기록 삭제를 지시한 혐의로 추가 기소 (직권남용)',
            '2025.02.13 경찰 특수단이 구속영장 재신청 → 출국금지 연장 조치',
            '2025.12.04 내란 특검 기소 (박종준·이광우·김신 공동)',
            '2026.06.01 결심공판(구형 7년) → 2026.7.9 1심 선고: 김성훈 징역 5년·법정구속 (형사26부 이현경)',
            '경호처 4명 선고: 박종준 4년, 김성훈 5년, 이광우 2년6개월(이상 법정구속), 김신 1년·집유 2년'
        ],
        trialStatus: '체포방해 1심 징역 5년·법정구속 (2026.7.9, 형사26부 이현경, 구형 7년) / 비화폰 기록 삭제 직권남용 별도 진행 중',
        sources: [
            { label: '한국일보', title: "'尹 체포 저지' 김성훈 징역 5년·박종준 징역 4년…법정 구속", url: 'https://www.hankookilbo.com/news/article/A2026070914350004154', date: '2026.7.9' },
            { label: '파이낸셜뉴스', title: "'尹 체포방해' 당시 경호처 처·차장 1심 실형…법정구속", url: 'https://www.fnnews.com/news/202607091450337673', date: '2026.7.9' }
        ]
    },
    '이광우': {
        id: 'leegwangwoo',
        name: '이광우',
        position: '전 대통령경호처 경호본부장',
        status: '법정구속',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의26부',
        judge: '이현경 부장판사',
        ...
        charges: [
            {
                ...
                name: '특수공무집행방해·직권남용·범인은닉',
                law: '형법 제144조·제123조·제151조',
                description: '박종준·김성훈과 공모하여 2024.12.31~2025.01.02 경호처 직원·차벽을 동원해 공수처의 윤석열 체포영장 집행을 저지한 혐의 (2025.12.04 내란 특검 기소). 경호본부장으로서 현장 경호 인력 운용을 총괄',
                prosecutionRequest: '특검 구형 징역 5년 (2026.06.01 결심공판)',
                verdict: '1심 징역 2년 6개월, 법정구속 (2026.7.9, 서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '2026.7.9 선고 — 이광우 징역 2년 6개월·법정구속. 구형 5년(박종준·김성훈 7년보다 2년 낮음)의 절반. 처장·차장 지휘 라인 아래 현장 책임자로서의 가담 수준이 형량에 반영'
            }
        ],
        summary: {
            prosecutionTotal: '특수공무집행방해·직권남용·범인은닉: 특검 구형 징역 5년 (2026.06.01 결심)',
            verdictTotal: '체포방해 1심 징역 2년 6개월·법정구속 (2026.7.9, 형사26부 이현경)',
            ratio: '체포방해 징역 2년 6개월 (구형 5년)'
        },
        keyFacts: [
            '전 대통령경호처 경호본부장. 경호처 현장 경호 인력 운용을 총괄하는 직책',
            '2024.12.31 윤석열 체포영장 발부 후 박종준·김성훈과 공모, 경호처 직원·차벽 동원하여 영장 집행 저지',
            '2025.01.03 공수처 1차 체포영장 집행 무산의 현장 책임자',
            '2025.02.13 경찰 특수단이 구속영장 재신청 → 출국금지 연장 조치',
            '2025.12.04 내란 특검 기소 (박종준·김성훈·김신 공동)',
            '2026.06.01 결심공판: 형사합의26부 이현경 부장판사 - 특검 징역 5년 구형',
            '같은 사건 동일 재판부 구형: 박종준 7년 / 김성훈 7년 / 이광우 5년 / 김신(가족경호부장) 3년 — 지휘 위계에 따른 차등 구형',
            '2026.7.9 1심 선고: 박종준 4년, 김성훈 5년, 이광우 2년6개월(이상 법정구속), 김신 1년·집유 2년 (형사26부 이현경)'
        ],
        trialStatus: '체포방해 1심 징역 2년 6개월·법정구속 (2026.7.9, 형사26부 이현경, 구형 5년)',
        sources: [
            { label: '한국일보', title: "'尹 체포 저지' 김성훈 징역 5년·박종준 징역 4년…법정 구속", url: 'https://www.hankookilbo.com/news/article/A2026070914350004154', date: '2026.7.9' },
            { label: '파이낸셜뉴스', title: "'尹 체포방해' 당시 경호처 처·차장 1심 실형…법정구속", url: 'https://www.fnnews.com/news/202607091450337673', date: '2026.7.9' }
        ]
    ...
    '여인형': {
        ...
        court: '서울중앙지방법원 형사합의26부',
        judge: '이현경 부장판사',
        verdictDate: '2026년 9월 21일 (내란 1심)',
        charges: [
            {
                id: 1,
                name: '내란중요임무종사',
                ...
                prosecutionRequest: '징역 30년 (내란특검 구형)',
                verdict: '유죄 — 징역 18년 (2026.9.21 1심, 형사합의26부)',
                reason: '재판부(이현경): "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다" — 방첩사 병력 투입·체포조 운영 지휘를 내란 중요임무 종사로 인정. 함께 선고된 군 지휘관 5명 중 최고형(구형 30년의 60%)'
            },
            {
                id: 2,
                name: '위증',
                ...
                prosecutionRequest: '조사 중',
                verdict: '재판 진행 중',
                reason: '※ 2026.9.21 내란 1심 선고에 위증 혐의가 포함됐는지는 기사에서 확인되지 않음'
            },
            {
                id: 3,
                name: '일반이적 (평양 무인기)',
                law: '형법 제93조',
                description: '2024년 평양 무인기 침투 작전 관여. 2025.11.10 기소',
                prosecutionRequest: '특검 구형',
                verdict: '1심 징역 15년 (2026.06.12)',
                reason: '서울중앙지법 형사합의36부(이정엽 부장판사): 국군방첩사령관으로서 무인기 작전에 관여, 일반이적 인정. 윤석열·김용현(각 30년) 대비 낮은 15년'
            }
        ],
        summary: {
            prosecutionTotal: '징역 30년 (내란특검 구형)',
            verdictTotal: '징역 18년 (내란 1심, 2026.9.21) · 일반이적 별건 15년 (6.12)',
            ratio: '구형 30년 → 선고 18년 (60%) — 군 지휘관 5명 중 최고형'
        },
        keyFacts: [
            ...
            '재판 군사법원→서울중앙지법 이송 (2026.1)',
            '2026.9.21 내란중요임무종사 1심 징역 18년 (서울중앙지법 형사합의26부 이현경, 구형 30년) — 군 지휘관 5명 중 최고형',
            '별건(일반이적 1심 15년) 구속 상태 유지'
        ],
        trialStatus: '내란 1심 징역 18년 선고 (2026.9.21, 형사합의26부) / 일반이적 1심 15년 (6.12) — 항소 여부 미확인',
        judgeHistory: {
            judgeName: '이현경',
            position: '서울중앙지방법원 형사합의26부 부장판사',
            recentCases: [
    ...
    '윤석열': {
        ...
        charges: [
            ...
            },
            {
                ...
                verdict: '1심 징역 5년 → 항소심 징역 7년 → 대법원 상고기각·징역 7년 확정 (2026.7.9, 대법원 3부, 재판장 이흥구·주심 이숙연)',
                reason: '서울고법 형사1부(윤성식 부장판사): "현직 대통령으로서 헌법 준수·국가 보위·국민 자유와 권리 증진의 막중한 책임에도, 사회적 혼란을 가중하는 등 대통령으로서의 책무를 저버렸다". 1심 무죄였던 국무위원 2인 심의권 침해(직권남용), 외신비서관 허위보도 대응 지침 배포 지시도 유죄로 뒤집힘. 경호처 공무원을 "사병처럼 동원". 상고심: 대법원 3부(재판장 이흥구·주심 이숙연, 오석준·노경필 대법관) 배당 — 윤석열 12·3 비상계엄 관련 첫 대법원 심리 (오석준 대법관 회피, 선고에는 재판장 이흥구·주심 이숙연·노경필 3인 참여). 특검·윤석열 양측 모두 상고 → 2026.7.9 대법원 3부 상고기각으로 징역 7년 확정 (12·3 계엄 583일 만의 윤석열 관련 첫 대법원 판단). 대법원: 공수처 수사는 적법했고, 대통령이 피의자인 사건은 재직 중에도 수사가 허용되며, 압수수색 거부에는 정당한 사유가 필요하다고 판시'
            },
            {
                id: 3,
                name: '일반이적 (평양 무인기)',
                law: '형법 제93조',
                description: '2024년 평양 무인기 침투 작전 주도 — 비상계엄 명분 조성을 위해 평양에 무인기를 투입, 북한의 군사적 반응을 유도. 일반이적·직권남용권리행사방해. 2025.11.10 기소',
                prosecutionRequest: '징역 30년 (특검 구형)',
                verdict: '1심 징역 30년 (2026.06.12)',
                reason: '서울중앙지법 형사합의36부(이정엽 부장판사): "무인기 침투 작전이 대한민국 군사상 이익을 침해했고, 윤석열이 김용현 등과 처음부터 작전을 계획" → 일반이적 공동정범 인정. 직권남용: "정치적 이익을 위해 비상계엄 상황을 조성하려는 사적 목적으로 군인들에게 의무 없는 일을 강요". 같은 사건에서 김용현 30년, 여인형 15년, 김용대(전 드론작전사령관) 3년·집행유예 5년'
            },
            {
                id: 4,
                name: '위증',
                ...
                verdict: '1심 무죄 (2026.05.28) — 윤석열 내란 관련 기소 사건 중 첫 무죄',
                reason: '서울중앙지법 형사합의32부(류경진 부장판사): ① "주관적 평가·법률적 의견 진술은 위증죄 대상 아님" — 윤석열의 "국무위원들이 외관을 갖추려고 온 인형도 아니고" 답변은 단순 평가, ② "한덕수 건의 이전부터 윤석열이 국무위원 소집을 계획했을 가능성이 높음" — 위증의 전제 자체 부정, ③ "기억에 반하는 진술로 단정하기 어려움", ④ "범죄 증명이 없음". 같은 12·3 비상계엄 사건군의 사후 계엄선포문 강의구 전 부속실장은 같은 날 형사합의30부(박옥희)에서 징역 1년 6개월·법정구속과 정반대 결과. 특검 상고 검토'
            },
            {
                id: 5,
                name: '공직선거법·정치자금법 위반 (김건희 특검)',
                law: '공직선거법 위반(허위사실 공표), 정치자금법 위반',
                description: '① 정치자금법: 부인 김건희와 공모해 2021.6~2022.3 정치브로커 명태균으로부터 약 2억7천만원 상당 여론조사를 무상 제공받음. ② 공직선거법: 20대 대선 후보 시절 「건진법사(전성배)를 김건희와 함께 만난 적 없다」·「윤우진에게 변호사 소개한 적 없다」 등 허위사실 공표. 김건희 특검(민중기) 기소. ※12·3 내란과 무관한 별개 사건',
                prosecutionRequest: '정치자금법 징역 4년·추징 1억3,720만원 + 공직선거법 징역 2년 (김건희 특검 구형)',
                verdict: '정치자금법(명태균 무상 여론조사) 1심 징역 2년·추징 1,396만원 유죄 (2026.7.13, 형사33부 이진관) + 공직선거법(허위사실공표) 1심 징역 1년 6개월·집유 3년 당선무효형 (2026.7.27, 형사21부 조순표)',
                reason: '정치자금법(형사33부 이진관): 윤석열 부부와 명태균 사이 「순차적·암묵적 의사합치」 인정, 무상 여론조사 58회 중 14회 유죄 — 같은 혐의로 별건 기소된 김건희는 무죄로 엇갈림, 명태균은 징역 1년 6개월·법정구속. 공직선거법(형사21부 조순표): 관훈클럽 토론회·언론 인터뷰 발언을 모두 허위사실 공표로 인정하며 「죄질이 매우 엄중」 → 당선무효형. 형 확정 시 국민의힘은 2022 대선 국고보전 선거비용·기탁금 약 397억원 반환 의무. 양측 항소 전망'
            }
        ],
        summary: {
            prosecutionTotal: '내란수괴: 사형 + 체포방해: 징역 10년 + 위증: 징역 2년 + 공직선거법·정치자금법: 재판 중',
            verdictTotal: '내란수괴: 무기징역 (1심, 항소심 진행 중) + 체포방해: 징역 7년 확정 (2026.7.9 대법원 상고기각) + 위증: 1심 무죄 (2026.05.28, 형사32부 류경진) + 일반이적(평양 무인기): 징역 30년 (2026.06.12, 형사36부 이정엽) + 정치자금법(명태균 여론조사): 징역 2년 (2026.7.13, 형사33부 이진관) + 공직선거법(허위사실공표): 징역 1년 6개월·집유 3년 당선무효형 (2026.7.27, 형사21부 조순표)',
            ratio: '체포방해 징역 7년 대법원 확정(2026.7.9, 윤석열 첫 대법원 판단), 위증 무죄 — 내란 관련 기소 사건 중 첫 무죄'
        },
        keyFacts: [
            '대한민국 헌정사상 최초 현직 대통령 구속',
            '2024.12.3 비상계엄 선포',
            '2025.1.15 공수처 체포, 2025.4.4 헌재 탄핵 인용 (파면)',
            '체포방해 1심 징역 5년 (2026.1.16) → 항소심 징역 7년 (2026.4.29) → 2026.7.9 대법원 상고기각·징역 7년 확정 (윤석열 관련 첫 대법원 판단)',
            '내란수괴 사형 구형 (2026.1.13) → 1심 무기징역 (2026.2.19)',
            '내란수괴 항소심 2026.4.27 개시 — 서울고법 형사12-1부(이승철 재판장)',
            '위증 징역 2년 구형 (2026.4.16) → 1심 무죄 (2026.05.28, 서울중앙지법 형사32부 류경진) — 내란 관련 기소 사건 중 첫 무죄',
            '재판부 무죄 근거: "주관적 평가·법률적 의견 진술은 위증죄 대상 아님", "한덕수 건의 이전부터 국무위원 소집 계획 가능성 높음"',
            '정치자금법(명태균 무상 여론조사) 1심 징역 2년·추징 1,396만원 유죄 (2026.7.13, 형사33부 이진관) — 같은 혐의 별건 기소된 김건희는 무죄로 엇갈림, 명태균 징역 1년 6개월·법정구속',
            '공직선거법(허위사실공표) 1심 징역 1년 6개월·집유 3년 당선무효형 (2026.7.27, 형사21부 조순표) — 확정 시 국민의힘 대선 국고보전 397억원 반환'
        ],
        verdictDate: '2026년 7월 27일 (공직선거법 당선무효형)',
        trialStatus: '내란수괴 항소심 진행 중 (2026.4.27 개시) + 체포방해 징역 7년 대법원 확정 (2026.7.9) + 위증 1심 무죄 (2026.05.28) + 일반이적(평양 무인기) 1심 징역 30년 (2026.06.12) + 정치자금법(명태균 여론조사) 1심 징역 2년 (2026.7.13) + 공직선거법(허위사실공표) 1심 징역 1년 6개월·집유 3년 당선무효형 (2026.7.27)',
        sentencingGuidelines: [
            {
                crime: '내란수괴 (형법 제87조)',
            ...
            },
            {
                ...
                verdict: '1심 징역 5년 → 항소심 징역 7년 → 대법원 확정 (2026.7.9)',
        ...
        appealHistory: {
            ...
            obstruction: {
                court: '서울고등법원 형사1부',
                judge: '윤성식 부장판사',
                verdict: '징역 7년 (1심 5년→항소심 7년) → 2026.7.9 대법원 상고기각 확정',
                date: '2026.4.29',
        ...
        charges: [
            {
                ...
                prosecutionRequest: '징역 30년 (내란특검 구형)',
                verdict: '유죄 — 징역 15년 (2026.9.21 1심, 형사합의26부)',
                reason: '재판부(이현경): "헌법기관의 권능행사를 불가능하게 하는 것은 어떤 경우에도 용인될 수 없다", "군 사명과 의무, 정치적 중립성을 저버리고 특정 세력의 정치적 이익을 위해 군사력을 사용했다" — 수방사 병력의 국회 투입 지휘를 내란 중요임무 종사로 인정 (구형 30년의 50%)'
            }
        ],
        summary: {
            prosecutionTotal: '징역 30년 (내란특검 구형)',
            verdictTotal: '징역 15년 (1심, 2026.9.21)',
            ratio: '구형 30년 → 선고 15년 (50%)'
        },
        keyFacts: [
            ...
            '국방부 파면 징계 (2025.12.29)',
            '재판 군사법원→서울중앙지법 이송 (2026.1)',
            '2026.9.21 1심 징역 15년 (서울중앙지법 형사합의26부 이현경, 구형 30년) — 여인형 18년 다음으로 무거운 형',
            '선고와 함께 보석 취소 → 재구금'
        ],
        trialStatus: '1심 징역 15년 선고 (2026.9.21, 형사합의26부) — 보석 취소·재구금, 항소 여부 미확인',
        judgeHistory: {
            judgeName: '이현경',
            position: '서울중앙지방법원 형사합의26부 부장판사',
            recentCases: [
    ...
    '심우정': {
        ...
        charges: [
            ...
            {
                id: 3,
                name: '내란중요임무종사·직권남용 (구속영장 기각)',
                law: '형법 제87조, 제123조',
                description: '2024.12.3 비상계엄 후 박성재 전 법무장관 지시로 계엄사 합동수사본부 검사 파견을 검토하고 「비상계엄 하 재판 관할」 문건 작성에 관여한 혐의 + 윤석열 구속취소 결정 후 즉시항고(항고) 포기 지휘 혐의',
                prosecutionRequest: '구속영장 청구 (2026.7.14, 권창영 2차 종합특검)',
                verdict: '구속영장 기각 (2026.7.16) — 불구속 수사',
                reason: '서울중앙지법 부동식 내란 영장전담 부장판사: "증거인멸 염려에 대한 소명이 부족하고, 도망할 염려가 있다고 보기 어렵다"며 기각. (전무곤 전 대검 기획조정부장과 함께 청구됐으나 심우정은 기각 → 특검은 불구속 상태로 수사 계속)'
            }
        ],
        summary: {
            prosecutionTotal: '내란 구속영장 청구(2026.7.14) + 범인도피·직권남용 불구속 기소',
            verdictTotal: '내란 구속영장 기각(2026.7.16, 불구속 수사) / 기존 혐의 1심 재판 진행 중',
            ratio: '-'
        },
        keyFacts: [
            '2026.7.16 내란중요임무종사·직권남용 구속영장 기각 — 부동식 내란 영장전담 부장판사 "증거인멸·도망 염려 소명 부족"(불구속 수사)',
            '2026.7.14 권창영 2차 종합특검이 위 혐의로 구속영장 청구(전무곤 검사장과 함께)',
            '혐의: 계엄 후 박성재 지시로 합수부 검사 파견 검토·「비상계엄 하 재판 관할」 문건 작성 관여 + 윤석열 구속취소 즉시항고 포기 지휘',
            '계엄 당일~4일간 특별활동비 3억 4,200만원 사용',
            '범인도피(채상병 특검)·직권남용 혐의 불구속 기소 상태'
        ],
        trialStatus: '내란 혐의 구속영장 기각(불구속 수사) / 범인도피·직권남용 1심 재판 진행 중'
    },
    '이완규': {
        id: 'leewankyu',
        name: '이완규',
        ...
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '2025.12.8 기소. 12·3 계엄 선포 후 국민의힘 의원총회 소집 장소를 국회→당사→국회→당사로 3차례 변경해 소속 의원들의 계엄 해제 표결 참여를 방해한 혐의',
                prosecutionRequest: '재판 진행 중',
                verdict: '재판 진행 중',
                reason: '추경호 측: "특검이 직접 증거 없이 억측·상상으로 기소, 법왜곡죄에 해당" — 혐의 전면 부인'
            }
        ],
        summary: {
            prosecutionTotal: '재판 진행 중',
            verdictTotal: '재판 진행 중 (형사34부 한성진 부장판사)',
            ratio: '-'
        },
        keyFacts: [
            '12·3 계엄의 밤, 국민의힘 의원총회 장소를 국회→당사→국회→당사로 3차례 변경',
    ...
    '김현태': {
        id: 'kimhyuntae',
        name: '김현태',
        position: '전 707특수임무단장 (육군 대령)',
        status: '법정구속 (1심 징역 12년)',
        statusColor: 'red',
        court: '서울중앙지방법원 형사합의37-2부',
        judge: '오창섭·류창성·장성훈 부장판사',
        verdictDate: '2026년 8월 27일 (1심)',
        charges: [
            {
                id: 1,
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄의 밤, 707특임단을 이끌고 국회 봉쇄·침투에 가담. 곽종근 특전사령관 지시에 따라 예하 대대장들에게 계엄해제 의결을 시도하는 국회의원을 끌어내라는 취지의 지시를 하달. 반국가세력 합동체포조·선관위 점거에도 관여. 2025.2.28 내란중요임무종사·직권남용 혐의로 불구속 기소',
                prosecutionRequest: '징역 18년 (내란특검 구형, 2026.7.28 결심 — "내란 행동대장")',
                verdict: '유죄 — 징역 12년·법정구속 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): "용납할 수 없는 범행" — 707특임단의 국회 봉쇄·침투 지휘를 내란 중요임무 종사로 인정, 선고 후에도 계엄 정당성을 주장하며 법치에 저항해 온 점을 양형에 반영해 7명 중 유일하게 법정구속(구형 18년→12년) / 내란특검: 김현태가 707특임단을 실질 지휘한 「내란 행동대장」. 김현태 측: "내란 인식이 없었고, 국회의원을 끌어내거나 표결을 방해한 증거가 없다" — 계엄 선포 후 지휘관 전화를 받고 국회에 가 건물을 봉쇄했을 뿐이며, 명령을 따른 군인을 희생양 삼아선 안 된다고 소신 주장. 함께 기소된 이상현 전 1공수특전여단장(준장)에게는 징역 15년 구형'
            }
        ],
        summary: {
            prosecutionTotal: '징역 18년 (내란특검 구형)',
            verdictTotal: '징역 12년·법정구속 (1심, 2026.8.27)',
            ratio: '구형 18년 → 선고 12년 (67%)'
        },
        keyFacts: [
            '전 육군특수전사령부 707특수임무단장 (대령, 육사 57기)',
            '2024.12.3 밤 헬기로 국회에 가장 먼저 도착(23:49) — "유리창을 깨고 본청에 진입하라", "전기를 끊을 방법을 찾으라" 지시',
            '헌재 탄핵심판 증언: 곽종근 사령관으로부터 "(국회에) 150명이 넘으면 안 된다"는 말을 직접 들었다',
            '2024.12.9 기자회견(눈물): "707부대원들은 모두 피해자, 전 김용현 국방장관에게 이용당한 가장 안타까운 피해자"',
            '2025.2.28 내란중요임무종사·직권남용 혐의 불구속 기소 (계엄 가담 군·경 9명 불구속 기소)',
            '2026.7.28 결심공판 — 내란특검 징역 18년 구형("내란 행동대장")',
            '2026.8.27 1심 징역 12년·법정구속 (형사합의37-2부 오창섭) — 재판부 "용납할 수 없는 범행", 선고 후에도 유튜브 등에서 계엄 정당성을 주장하며 법치에 저항해 온 점을 양형에 반영',
            '함께 기소된 7명 중 이상현 징역 10년(구형 15년)·김봉규 7년·정성욱 7년·김대우 5년, 박헌수·고동희는 내란 고의 불인정으로 무죄'
        ],
        trialStatus: '1심 징역 12년·법정구속 (2026.8.27, 형사37-2부 오창섭) — 7명 중 유일하게 법정구속, 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
            position: '서울중앙지방법원 형사합의37-2부 부장판사',
            recentCases: [
                { year: '2026', caseName: '군 지휘관 7인 내란중요임무종사 사건 (김현태·이상현·김봉규·정성욱·김대우·박헌수·고동희)', role: '재판장', verdict: '5명 실형(징역 12년·10년·7년·7년·5년, 김현태만 법정구속) · 2명 무죄(내란 고의 불인정) (2026.8.27)' }
            ],
            profile: '서울중앙지방법원 형사합의37-2부 재판장(오창섭·류창성·장성훈). 2026.8.27 군 지휘관 7인 1심에서 "용납할 수 없는 범행"이라면서도 구형(10~18년) 대비 감형, 박헌수·고동희는 내란의 고의가 인정되지 않는다며 무죄'
        }
    },
    '이상현': {
        id: 'leesanghyun',
        name: '이상현',
        position: '전 특전사 제1공수특전여단장 (준장)',
        status: '불구속 (1심 징역 10년)',
        statusColor: 'green',
        court: '서울중앙지방법원 형사합의37-2부',
        judge: '오창섭·류창성·장성훈 부장판사',
        verdictDate: '2026년 8월 27일 (1심)',
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 제1공수특전여단 병력을 이끌고 국회 봉쇄·침투에 관여한 혐의. 2025.2.28 불구속 기소',
                prosecutionRequest: '징역 15년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '유죄 — 징역 10년 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): "용납할 수 없는 범행" — 1공수특전여단 병력의 국회 봉쇄·침투 관여를 내란 중요임무 종사로 인정 (구형 15년→10년) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 같은 재판에서 김현태 전 707특임단장에게는 징역 18년 구형'
            }
        ],
        summary: {
            prosecutionTotal: '징역 15년 (내란특검 구형)',
            verdictTotal: '징역 10년 (1심, 2026.8.27)',
            ratio: '구형 15년 → 선고 10년 (67%)'
        },
        keyFacts: [
            '전 육군특수전사령부 제1공수특전여단장 (준장)',
            '12·3 계엄의 밤 병력을 이끌고 국회 봉쇄·침투에 관여',
            '2026.7.28 결심공판 — 내란특검 징역 15년 구형 (지휘관 구형 중 김현태 18년 다음으로 중형)',
            '2026.8.27 1심 징역 10년 (서울중앙지법 형사합의37-2부 오창섭, 구형 15년) — 김현태 12년 다음으로 무거운 형'
        ],
        trialStatus: '1심 징역 10년 선고 (2026.8.27, 형사37-2부) — 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
            position: '서울중앙지방법원 형사합의37-2부 부장판사',
            recentCases: [
    ...
    '박헌수': {
        id: 'parkheonsoo',
        name: '박헌수',
        position: '전 국방부 조사본부장',
        status: '불구속 (1심 무죄)',
        statusColor: 'green',
        court: '서울중앙지방법원 형사합의37-2부',
        judge: '오창섭·류창성·장성훈 부장판사',
        verdictDate: '2026년 8월 27일 (1심 무죄)',
        charges: [
            {
                id: 1,
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 정치인 체포조 운영에 가담한 혐의 (국방부 조사본부 인력 동원)',
                prosecutionRequest: '징역 10년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '무죄 — 내란의 고의 불인정 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): 내란의 고의가 인정되지 않는다 → 무죄 (구형 10년) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담"'
            }
        ],
        summary: {
            prosecutionTotal: '징역 10년 (내란특검 구형)',
            verdictTotal: '무죄 (1심, 2026.8.27)',
            ratio: '구형 10년 → 무죄'
        },
        keyFacts: [
            '전 국방부 조사본부장',
            '12·3 계엄 당시 정치인 체포조 운영 가담 혐의',
            '2026.7.28 결심공판 — 내란특검 징역 10년 구형',
            '2026.8.27 1심 무죄 (서울중앙지법 형사합의37-2부 오창섭) — "내란의 고의가 인정되지 않는다" (고동희와 함께 7명 중 2명 무죄)'
        ],
        trialStatus: '1심 무죄 (2026.8.27, 형사37-2부) — 내란 고의 불인정, 특검 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
            position: '서울중앙지방법원 형사합의37-2부 부장판사',
            recentCases: [
        ...
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 방첩사 수사단 인력을 동원해 정치인 체포조 운영에 가담한 혐의',
                prosecutionRequest: '징역 12년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '유죄 — 징역 5년 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): "용납할 수 없는 범행" — 방첩사 수사단 인력의 체포조 운영 가담을 내란 중요임무 종사로 인정 (구형 12년→5년, 유죄 5명 중 최저) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 방첩사는 여인형 사령관 지휘 아래 체포조 운영의 핵심 조직으로 지목됨'
            }
        ],
        summary: {
            prosecutionTotal: '징역 12년 (내란특검 구형)',
            verdictTotal: '징역 5년 (1심, 2026.8.27)',
            ratio: '구형 12년 → 선고 5년 (42%)'
        },
        keyFacts: [
            '전 국군방첩사령부 방첩수사단장 (준장)',
            '12·3 계엄 당시 정치인 체포조 운영 가담 혐의',
            '2026.7.28 결심공판 — 내란특검 징역 12년 구형',
            '2026.8.27 1심 징역 5년 (서울중앙지법 형사합의37-2부 오창섭, 구형 12년) — 유죄 5명 중 가장 낮은 형'
        ],
        trialStatus: '1심 징역 5년 선고 (2026.8.27, 형사37-2부) — 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
            position: '서울중앙지방법원 형사합의37-2부 부장판사',
            recentCases: [
    ...
    '고동희': {
        ...
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 정보사령부 계획처장으로서 내란에 가담한 혐의',
                prosecutionRequest: '징역 10년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '무죄 — 내란의 고의 불인정 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): 내란의 고의가 인정되지 않는다 → 무죄 (구형 10년) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담"'
            }
        ...
        keyFacts: [
            '전 국군정보사령부 계획처장 (대령)',
            '12·3 계엄 당시 내란 가담 혐의 — 정보사는 선관위 점거·직원 체포 등에 동원',
            '2026.7.28 결심공판 — 내란특검 징역 10년 구형',
            '2026.8.27 1심 무죄 (서울중앙지법 형사합의37-2부 오창섭) — "내란의 고의가 인정되지 않는다" (박헌수와 함께 7명 중 2명 무죄)'
        ],
        trialStatus: '1심 무죄 (2026.8.27, 형사37-2부) — 내란 고의 불인정, 특검 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
    ...
    '김봉규': {
        id: 'kimbonggyu',
        name: '김봉규',
        position: '전 정보사령부 중앙신문단장 (대령)',
        status: '불구속 (군 파면, 1심 징역 7년)',
        statusColor: 'green',
        court: '서울중앙지방법원 형사합의37-2부',
        judge: '오창섭·류창성·장성훈 부장판사',
        verdictDate: '2026년 8월 27일 (1심)',
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 노상원·문상호의 지시로 정보사 요원 약 40명 명단을 「합동수사본부 제2수사단」에 투입하기 위해 준비하고, 선관위 직원 체포·구금을 위해 인력을 편성·임무를 부여한 혐의. 야구방망이·케이블타이·안대·마스크·밧줄 등 물품 준비',
                prosecutionRequest: '징역 12년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '유죄 — 징역 7년 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): "용납할 수 없는 범행" — 정보사 요원 명단 준비·선관위 직원 체포조 편성 관여를 내란 중요임무 종사로 인정 (구형 12년→7년) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 별도로 군 징계에서 성실·복종 의무 위반으로 2026.1.29 파면(계엄 관여 대령 4명 중)'
            }
        ],
        summary: {
            prosecutionTotal: '징역 12년 (내란특검 구형)',
            verdictTotal: '징역 7년 (1심, 2026.8.27)',
            ratio: '구형 12년 → 선고 7년 (58%)'
        },
        keyFacts: [
            '전 국군정보사령부 중앙신문단장 (대령)',
            '노상원·문상호 지시로 정보사 요원 약 40명 명단 준비 — 「합수본 제2수사단」 투입 목적',
            '선관위 점거·직원 체포·구금을 위한 인력 편성 및 임무 부여',
            '야구방망이·케이블타이·안대·마스크·밧줄·식별 목걸이 등 물품 준비',
            '2026.1.29 군 징계 파면 (성실·복종 의무 위반, 계엄 관여 대령 4명 중)',
            '2026.7.28 결심공판 — 내란특검 징역 12년 구형',
            '2026.8.27 1심 징역 7년 (서울중앙지법 형사합의37-2부 오창섭, 구형 12년)'
        ],
        trialStatus: '1심 징역 7년 선고 (2026.8.27, 형사37-2부) / 군 징계 파면(2026.1.29) — 항소 여부 미확인',
        judgeHistory: {
            judgeName: '오창섭',
            position: '서울중앙지방법원 형사합의37-2부 부장판사',
            recentCases: [
    ...
    '정성욱': {
        id: 'jungsungwook',
        name: '정성욱',
        position: '전 정보사령부 100여단 제2사업단장 (대령)',
        status: '불구속 (군 파면, 1심 징역 7년)',
        statusColor: 'green',
        court: '서울중앙지방법원 형사합의37-2부',
        judge: '오창섭·류창성·장성훈 부장판사',
        ...
        charges: [
            {
                ...
                name: '내란중요임무종사',
                law: '형법 제87조',
                description: '12·3 계엄 당시 김봉규 중앙신문단장과 함께 노상원·문상호의 지시를 받아 정보사 요원 약 40명 명단을 준비하고, 선관위 직원 체포·구금을 위해 인력을 편성·임무를 부여한 혐의',
                prosecutionRequest: '징역 12년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '유죄 — 징역 7년 (2026.8.27 1심, 형사37-2부)',
                reason: '재판부(오창섭): "용납할 수 없는 범행" — 정보사 요원 명단 준비·선관위 직원 체포조 편성 관여를 내란 중요임무 종사로 인정 (구형 12년→7년) / 내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 별도로 군 징계에서 성실·복종 의무 위반으로 2026.1.29 파면(계엄 관여 대령 4명 중)'
            }
        ...
        keyFacts: [
            '전 국군정보사령부 100여단 제2사업단장 (대령)',
            '김봉규 중앙신문단장과 함께 노상원·문상호 지시로 정보사 요원 약 40명 명단 준비',
            '선관위 점거·직원 체포·구금을 위한 인력 편성 및 임무 부여',
            '2026.1.29 군 징계 파면 (성실·복종 의무 위반, 계엄 관여 대령 4명 중)',
            '2026.7.28 결심공판 — 내란특검 징역 12년 구형',
            '2026.8.27 1심 징역 7년 (서울중앙지법 형사합의37-2부 오창섭, 구형 12년)'
    ...
    '김용대': {
        ...
        status: '불구속',
        statusColor: 'green',
        court: '서울중앙지방법원 형사합의36부',
        judge: '이정엽 부장판사',
        verdictDate: '2026년 6월 12일',
        charges: [
            {
                id: 1,
                name: '일반이적 (평양 무인기)',
                law: '형법 제93조',
                description: '2024년 평양 무인기 침투 작전 실행 — 드론작전사령관으로서 작전 수행',
                prosecutionRequest: '특검 구형',
                verdict: '1심 징역 3년·집행유예 5년 (2026.06.12)',
                reason: '서울중앙지법 형사합의36부(이정엽 부장판사): 드론작전사령관으로서 무인기 작전을 수행했으나, 상부 지시에 따른 실행자라는 점이 양형에 반영되어 집행유예'
            }
        ],
        summary: {
            prosecutionTotal: '특검 구형',
            verdictTotal: '징역 3년·집행유예 5년 (2026.06.12, 형사36부 이정엽)',
            ratio: '집행유예'
        },
        keyFacts: [
            '전 드론작전사령관 — 2024년 평양 무인기 침투 작전의 실행 지휘',
...
export default function SentencingAnalysis() {
    ...
    const getMergedPersonData = (name) => {
        ...
        // 구속 상태는 코드(정적 데이터)에서 선고 결과와 함께 관리한다 — Firestore 크롤러 값(예: 김건희 '불구속')이 덮어쓰지 않도록 정적 우선
        const mergedStatus = staticData.status || clean(dynamicData.status);
        ...
        return {
            ...
            // 정적 judge(재판장)가 지정된 인물은 그 판사와 다른 Firestore judgeHistory(크롤러 기본값 오염)를 쓰지 않는다
            judgeHistory: (() => {
                const dyn = dynamicData.judgeHistory;
                const dynOk = dyn?.judgeName && (!staticData.judge || staticData.judge.includes(dyn.judgeName));
                if (dynOk) return dyn;
                return staticData.judgeHistory || (staticData.judge ? null : dyn);
            })(),
                    ...
                    <div className="container mx-auto max-w-4xl">
                        ...
                        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                            <div className="p-4 bg-amber-50 border-b">
                                <h2 className="font-bold text-gray-900">🎖️ 12·3 내란 가담 군 징계 명단</h2>
                                <p className="text-base text-gray-600 mt-1">형사 재판과 <b>별개</b>인 군 인사·징계 조치입니다. 12·3 이후 창군 이래 최대 규모 — <b>파면·해임 장군 14명(별 31개 추락)</b>, 대령 4명 파면 등. ※12·3은 군형법상 <b>반란죄</b>가 아닌 형법상 <b>내란죄</b>로 기소됐습니다(12·12 군사반란과 적용 법조가 다름).</p>
                            </div>
                            <div className="divide-y">
                                {[
                                    ...
                                    { name: '이상현', rank: '전 특전사 제1공수특전여단장(준장)', action: '파면', color: 'red', note: '계엄 선포 후 국회에 병력을 투입하고 본청 진입을 시도한 행위로 파면. 형사 재판에서는 내란중요임무종사로 기소돼 특검이 징역 15년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '김대우', rank: '전 방첩사 방첩수사단장(준장)', action: '파면', color: 'red', note: '이재명 당시 민주당 대표 등 주요 정치인 14명 체포조를 편성·운영한 행위로 파면. 형사 재판에서는 특검이 징역 12년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '김현태', rank: '전 707특수임무단장(대령)', action: '파면', color: 'red', note: '국회 봉쇄·침투 관여(유리창을 깨고 본청 강제 진입)로 법령준수·성실의무 위반 파면(2026.1.29, 계엄 관여 대령 4명 중). 형사 재판에서는 특검이 「내란 행동대장」으로 규정하며 징역 18년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '고동희', rank: '전 정보사 계획처장(대령)', action: '파면', color: 'red', note: '계엄 당일 선관위 청사 장악에 관여 — 서버실을 촬영하고 출입 통제 등 임무를 현장 지휘한 행위로 파면(2026.1.29, 계엄 관여 대령 4명 중). 형사 재판에서는 특검이 징역 10년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '김봉규', rank: '전 정보사 중앙신문단장(대령)', action: '파면', color: 'red', note: '선관위 점거·직원 체포 관여 등 성실·복종 의무 위반으로 파면(2026.1.29, 계엄 관여 대령 4명 중). 형사 재판에서는 특검이 징역 12년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '정성욱', rank: '전 정보사 100여단 제2사업단장(대령)', action: '파면', color: 'red', note: '선관위 점거·직원 체포 관여 등 성실·복종 의무 위반으로 파면(2026.1.29, 계엄 관여 대령 4명 중). 형사 재판에서는 특검이 징역 12년 구형(2026.7.28), 1심 선고 8.27.' },
                                    { name: '박헌수', rank: '전 국방부 조사본부장', action: '업무배제·분리파견', color: 'amber', note: '체포조 지원 의혹으로 업무에서 배제되고 국군재정단으로 분리파견(보직해임 대신 인사조치) — 파면·해임 대상에는 포함되지 않았다. 형사 재판에서는 내란중요임무종사로 기소돼 특검이 징역 10년 구형(2026.7.28), 1심 선고 8.27.' },
                                ].map((d, i) => (
