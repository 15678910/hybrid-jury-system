    ...
    '윤석열': {
        ...
        charges: [
            ...
            },
            {
                ...
                verdict: '1심 징역 5년 → 항소심 징역 7년 → 대법원 상고기각·징역 7년 확정 (2026.7.9, 대법원 3부, 주심 이숙연)',
                reason: '서울고법 형사1부(윤성식 부장판사): "현직 대통령으로서 헌법 준수·국가 보위·국민 자유와 권리 증진의 막중한 책임에도, 사회적 혼란을 가중하는 등 대통령으로서의 책무를 저버렸다". 1심 무죄였던 국무위원 2인 심의권 침해(직권남용), 외신비서관 허위보도 대응 지침 배포 지시도 유죄로 뒤집힘. 경호처 공무원을 "사병처럼 동원". 상고심: 대법원 3부(이흥구·오석준·노경필·이숙연) 배당, 주심 이숙연 대법관 — 윤석열 12·3 비상계엄 관련 첫 대법원 심리. 특검·윤석열 양측 모두 상고 → 2026.7.9 대법원 3부 상고기각으로 징역 7년 확정 (12·3 계엄 583일 만의 윤석열 관련 첫 대법원 판단). 대법원: 공수처 수사는 적법했고, 대통령이 피의자인 사건은 재직 중에도 수사가 허용되며, 압수수색 거부에는 정당한 사유가 필요하다고 판시'
            },
            {
                id: 3,
                name: '일반이적 (평양 무인기)',
