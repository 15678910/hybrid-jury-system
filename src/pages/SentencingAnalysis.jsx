...
const personsData = {
    ...
    '김건희': {
        ...
        charges: [
            ...
            {
                id: 5,
                name: "[별개 1심] '매관매직' 알선수재 (이봉관 서희건설)",
                law: '특정범죄가중처벌법 위반 (알선수재)',
                period: '2022 (청탁 시점)',
                amount: '반클리프 목걸이·귀걸이 1억380만원 + 금거북이 265만원 + 바쉐론 시계 3,990만원 + 이우환 그림 1억4,000만원 + 디올백 등',
                prosecutionRequest: '징역 7년 6개월 (특검)',
                verdict: '1심 유죄 (세부 5개 혐의 전부)',
                reason: '서울중앙지법 형사합의21부(조순표 부장판사)는 사위 박성근 변호사 공직 임명·국가교육위원장 임명·로봇개 사업 지원·총선 공천 청탁 명목의 금품 수수 5건을 전부 유죄로 인정하고 "위법성을 인식하고도 은폐"했다고 판단, 징역 7년 선고(2026.6.26, 생중계). 도이치·통일교 사건(항소심 4년)과 별개의 1심 판결.'
            }
        ],
        summary: {
        ...
        keyFacts: [
            ...
            "[별개 사건] '매관매직' 알선수재 1심 — 징역 7년 선고 (2026.6.26, 서울중앙지법 형사합의21부 조순표): 이봉관 서희건설 회장에게 공직 임명·국가교육위원장·공천 청탁 명목 반클리프·금거북이·바쉐론 시계·이우환 그림·디올백 등 수수, 세부 5개 혐의 전부 유죄 (특검 구형 7년 6개월)"
        ],
        trialStatus: "도이치·통일교 사건 항소심 선고 완료(2026.04.28 징역 4년) — 상고심 진행 가능. ※별개 '매관매직'(이봉관 서희건설) 알선수재 1심 2026.6.26 징역 7년 선고(서울중앙지법 형사합의21부 조순표, 세부 5개 혐의 전부 유죄·특검 구형 7년 6개월)",
        sentencingGuidelines: [
            {
                crime: '주가조작 (자본시장법 위반)',
                standardRange: '3년~5년',
            ...
            },
            {
                ...
                verdict: '1심 징역 7년 (세부 5개 혐의 전부 유죄)',
                analysis: '서울중앙지법 형사합의21부(조순표)는 세부 5개 혐의를 전부 유죄로 인정하고 권고형 상한에 해당하는 징역 7년(특검 구형 7년 6개월)을 선고. 도이치·통일교 사건과 별개의 1심으로, 봐주기 없는 엄정한 양형으로 평가된다.'
            },
            {
