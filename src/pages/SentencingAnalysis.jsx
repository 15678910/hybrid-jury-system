...
const personsData = {
    ...
    '윤석열': {
        ...
        summary: {
            ...
            verdictTotal: '내란수괴: 무기징역 (1심, 항소심 진행 중) + 체포방해: 징역 7년 확정 (2026.7.9 대법원 상고기각) + 위증: 1심 무죄 (2026.05.28, 형사32부 류경진) + 일반이적(평양 무인기): 징역 30년 (2026.06.12, 형사36부 이정엽)',
        ...
        verdictDate: '2026년 5월 28일 (위증 무죄)',
        trialStatus: '내란수괴 항소심 진행 중 (2026.4.27 개시) + 체포방해 징역 7년 대법원 확정 (2026.7.9) + 위증 1심 무죄 (2026.05.28) + 일반이적(평양 무인기) 1심 징역 30년 (2026.06.12, 형사36부 이정엽)',
        sentencingGuidelines: [
            {
                crime: '내란수괴 (형법 제87조)',
