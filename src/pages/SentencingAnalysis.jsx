...
const personsData = {
    ...
    '김건희': {
        ...
        status: '구속',
        statusColor: 'red',
        court: '서울고등법원 형사15-2부 (항소심)',
        judge: '우인성 부장판사 (1심)',
        verdictDate: '2026년 4월 28일 (항소심)',
        appealVerdict: {
            date: '2026.04.28',
            court: '서울고법 형사15-2부',
        ...
        summary: {
            ...
            verdictTotal: '항소심 징역 4년 (1심 1년 8개월에서 가중), 벌금 5,000만원, 추징금 2,094만원',
            ratio: '항소심에서 1심 무죄 판결 다수 뒤집힘 — 형량 약 2.4배 가중'
        },
        keyFacts: [
        ...
        trialStatus: '항소심 선고 완료 (2026.04.28) — 상고심 진행 가능',
        ...
        keyIssues: [
            ...
            },
            {
                ...
                description: '형사소송법 298조 ②는 "법원은 심리의 경과에 비추어 상당하다고 인정할 때에는 공소사실 또는 적용법조의 추가 또는 변경을 요구하여야 한다"고 규정. 우인성 판사는 김건희 사건에서 내란공모·방조범 적용법조 추가를 요구하지 않음. 반면 이진관 판사(형사합의33부)는 동일 조항에 따라 한덕수 사건에서 방조죄→내란중요임무종사로 적용법조 변경을 적극 요구하여 실행.',
                opinion: {
                    prosecution: '우인성 재판부의 298조 ② 의무 미이행은 유죄 범위를 축소시킨 법률 의무 불이행. 이진관 판사와 대조적',
                    defense: '재판부의 법률 판단 재량 범위 내 결정이며, 검찰의 공소장 변경이 우선',
                    court: '동일 법률 조항에 대해 이진관 판사는 적극 이행, 우인성 판사는 불이행 — 재판부 간 법률 의무 해석 불균형'
                }
            },
            {
