        ...
        charges: [
            {
                ...
                name: '정치자금법 위반',
                law: '정치자금법',
                description: "이른바 '명태균 여론조사비 대납' 의혹. 2021년 4·7 서울시장 보궐선거를 앞두고 명태균에게 여론조사를 부탁한 뒤 강철원 전 정무부시장에게 실무를 맡기고, 후원자 김씨에게 비용을 대납하게 한 혐의",
                prosecutionRequest: '재판 진행 중',
                verdict: '재판 진행 중',
                reason: '오세훈 측: "명태균에 여론조사 부탁한 사실도, 부탁할 동기도 없다" 혐의 부인. "재판 기일이 지방선거 기간과 일치한다" 문제 제기'
            }
        ],
        summary: {
            prosecutionTotal: '재판 진행 중',
            verdictTotal: '재판 진행 중 (형사22부 조형우 부장판사)',
            ratio: '-'
        },
        keyFacts: [
            "'명태균 여론조사비 대납' 정치자금법 위반 의혹 (2021년 4·7 보궐선거 관련)",
            '공동 피고인: 강철원 전 서울시 정무부시장, 후원자 사업가 김씨',
            '2026.3.4 첫 공판, 강혜경(명태균 미래한국연구소 부소장) 증인신문',
            '서울중앙지법 형사합의22부(조형우 부장판사) 심리',
            '2026.6.10 공판기일 (6.17 피고인 신문으로 공판 마무리 예정)',
            '선고는 6.3 지방선거 이후 예정',
            '※ 내란 사건이 아닌 정치자금법 위반 사건 (명태균 연루)'
        ],
        trialStatus: '1심 재판 진행 중 (형사22부 조형우, 지방선거 이후 선고 예정)'
    },
    '김용군': {
        id: 'kimyonggun',
        name: '김용군',
