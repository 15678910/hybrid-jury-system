...
const personsData = {
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 2026.8.27 예정',
                reason: '내란특검: 김현태가 707특임단을 실질 지휘한 「내란 행동대장」. 김현태 측: "내란 인식이 없었고, 국회의원을 끌어내거나 표결을 방해한 증거가 없다" — 계엄 선포 후 지휘관 전화를 받고 국회에 가 건물을 봉쇄했을 뿐이며, 명령을 따른 군인을 희생양 삼아선 안 된다고 소신 주장. 함께 기소된 이상현 전 1공수특전여단장(준장)에게는 징역 15년 구형'
            }
        ],
        summary: {
            prosecutionTotal: '징역 18년 (내란특검 구형)',
            verdictTotal: '1심 선고 2026.8.27 예정 (형사37-2부)',
            ratio: '-'
        },
        keyFacts: [
            ...
            '2026.7.28 결심공판 — 내란특검 징역 18년 구형("내란 행동대장"), 8.27 1심 선고 예정',
            '함께 기소된 이상현 전 1공수특전여단장(준장) 징역 15년 구형'
        ],
        trialStatus: '1심 결심공판 종료 — 내란특검 징역 18년 구형(2026.7.28), 8.27 선고 예정 (형사37-2부 오창섭)'
    },
    '이상현': {
        id: 'leesanghyun',
        name: '이상현',
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 2026.8.27 예정',
                reason: '내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 같은 재판에서 김현태 전 707특임단장에게는 징역 18년 구형'
            }
        ],
        summary: {
            prosecutionTotal: '징역 15년 (내란특검 구형)',
        ...
        keyFacts: [
            ...
            '1심 선고 2026.8.27 예정 (서울중앙지법 형사합의37-2부)'
        ],
        trialStatus: '1심 결심 종료 — 내란특검 징역 15년 구형(2026.7.28), 8.27 선고 예정'
    },
    '박헌수': {
        id: 'parkheonsoo',
        name: '박헌수',
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 2026.8.27 예정',
                reason: '내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담"'
            }
        ],
        summary: {
        ...
        trialStatus: '1심 결심 종료 — 내란특검 징역 10년 구형(2026.7.28), 8.27 선고 예정'
    },
    '김대우': {
        id: 'kimdaewoo',
        name: '김대우',
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 2026.8.27 예정',
                reason: '내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 방첩사는 여인형 사령관 지휘 아래 체포조 운영의 핵심 조직으로 지목됨'
            }
        ],
        summary: {
        ...
        trialStatus: '1심 결심 종료 — 내란특검 징역 12년 구형(2026.7.28), 8.27 선고 예정'
    },
    '고동희': {
        id: 'kodonghee',
        name: '고동희',
    ...
    '김봉규': {
        ...
        charges: [
            {
                ...
                prosecutionRequest: '징역 12년 (내란특검 구형, 2026.7.28 결심)',
                verdict: '1심 선고 2026.8.27 예정',
                reason: '내란특검: "독자적인 지휘권을 가진 지휘관으로서 위법성을 인식하고도 내란에 적극 가담". 별도로 군 징계에서 성실·복종 의무 위반으로 2026.1.29 파면(계엄 관여 대령 4명 중)'
            }
        ],
        summary: {
            prosecutionTotal: '징역 12년 (내란특검 구형)',
        ...
        keyFacts: [
            ...
            '2026.7.28 결심공판 — 내란특검 징역 12년 구형, 8.27 선고 예정'
        ],
        trialStatus: '1심 결심 종료 — 내란특검 징역 12년 구형(2026.7.28), 8.27 선고 예정 / 군 징계 파면(2026.1.29)'
    },
    '정성욱': {
        id: 'jungsungwook',
        name: '정성욱',
