...
const personsData = {
    ...
    '박종준': {
        ...
        charges: [
            {
                ...
                name: '특수공무집행방해',
                law: '형법 제144조',
                description: '공수처 대통령 체포영장 집행 방해 혐의 (2025.12.4 기소)',
        ...
        summary: {
            prosecutionTotal: '증거인멸: 특검 구형 / 특수공무집행방해: 재판 진행 중',
            verdictTotal: '증거인멸 1심 무죄 (2026.05.21) / 특수공무집행방해 재판 진행 중',
            ratio: '증거인멸 무죄'
        },
        keyFacts: [
            '대통령경호처장으로서 공수처의 대통령 체포영장 집행 방해 혐의로 기소 (2025.12.4)',
            ...
            '재판부: "보안조치, 증거인멸로 단정 못해" "조지호 등 다른 사람 비화폰 미삭제로 인멸 고의 단정 어려움" "홍장원의 국회 비화폰 사진 공개 후 보안사고 대응"',
            '특검: "법리오해" 등 이유로 상고 검토 중',
            '특수공무집행방해(체포방해) 사건은 별도 재판 진행 중',
            '같은 형사32부 류경진 재판부의 이상민(7년, 구형 47%)→박종준(무죄)→조태용(주요혐의 무죄)→윤석열(위증 무죄) 4연속 무죄·관대 선고 패턴의 두 번째 사례'
        ],
        trialStatus: '증거인멸 1심 무죄 (특검 상고 검토) / 특수공무집행방해 1심 진행 중'
    },
    '여인형': {
        id: 'yeoinheong',
        name: '여인형',
