...
const personsData = {
    ...
    '윤석열': {
        ...
        summary: {
            ...
            verdictTotal: '내란수괴: 무기징역 (1심, 항소심 진행 중) + 체포방해: 징역 7년 (항소심, 대법원 3부 배당·주심 이숙연) + 위증: 1심 무죄 (2026.05.28, 형사32부 류경진)',
        ...
        trialStatus: '내란수괴 항소심 진행 중 (2026.4.27 개시) + 체포방해 상고심 대법원 3부 배당 (2026.05.20, 주심 이숙연) + 위증 1심 무죄 (2026.05.28, 특검 상고 검토)',
        sentencingGuidelines: [
            {
                crime: '내란수괴 (형법 제87조)',
