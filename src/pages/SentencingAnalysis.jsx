...
const personsData = {
    ...
    '박종준': {
        ...
        judge: '류경진 부장판사',
        verdictDate: '2026년 5월 21일 (증거인멸 1심)',
        charges: [
            {
                id: 1,
                ...
                verdict: '1심 선고 2026.7.9 예정 (서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '결심공판 2026.06.01 종료, 선고기일 2026.7.9 지정 (형사26부 이현경). 박종준·김성훈 각 7년, 이광우 5년, 김신 3년 구형. 같은 12·3 비상계엄 사건군에서 박종준 본인은 증거인멸 혐의로는 1심 무죄(형사32부 류경진)를 받았으나 체포방해 혐의는 별개 재판부(형사26부 이현경)에서 심리'
            },
            {
                id: 2,
                name: '증거인멸',
        ...
        summary: {
            ...
            verdictTotal: '특수공무집행방해 1심 선고 2026.7.9 예정 (형사26부 이현경) / 증거인멸 1심 무죄 (2026.05.21, 형사32부 류경진)',
            ratio: '증거인멸 무죄 / 체포방해 선고 대기 (구형 7년)'
        },
        keyFacts: [
            ...
            '2026.06.01 결심공판: 서울중앙지법 형사합의26부(이현경 부장판사) - 박종준 7년, 김성훈 7년, 이광우 5년, 김신 3년 각각 구형',
        ...
        trialStatus: '체포방해 1심 선고 2026.7.9 예정 (형사26부 이현경, 구형 7년) / 증거인멸 1심 무죄 (특검 상고 검토)',
        sources: [
            { label: '뉴스1', title: "'尹 체포방해' 경호처 前 처·차장 징역 7년 구형…내달 9일 선고", url: 'https://www.news1.kr/society/court-prosecution/6184311', date: '2026.6.1' },
            { label: '머니투데이', title: "'체포 방해' 박종준 경호처장 9일 선고", url: 'https://www.mt.co.kr/society/2026/07/05/2026070510061476099', date: '2026.7.5' }
        ]
    },
    '김성훈': {
        id: 'kimseonghun',
        ...
        charges: [
            {
                ...
                prosecutionRequest: '특검 구형 징역 7년 (2026.06.01 결심공판)',
                verdict: '1심 선고 2026.7.9 예정 (서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '체포영장 집행 방해 사건 결심 2026.06.01 종료, 박종준과 동일 7년 구형. 선고기일 2026.7.9 지정 (형사26부 이현경)'
            },
            {
                id: 2,
        ...
        summary: {
            ...
            verdictTotal: '체포방해 사건 1심 선고 2026.7.9 예정 (형사26부 이현경)',
            ratio: '체포방해 선고 대기 (구형 7년 = 박종준 처장과 동일)'
        },
        keyFacts: [
            ...
            '2026.06.01 결심공판: 형사합의26부 이현경 부장판사 - 특검 징역 7년 구형 (박종준과 동일)',
            '선고일: 2026.7.9 (서울중앙지법 형사합의26부 이현경 부장판사)'
        ],
        trialStatus: '체포방해 1심 선고 2026.7.9 예정 (형사26부 이현경, 구형 7년) / 비화폰 기록 삭제 직권남용 별도 진행 중',
        sources: [
            { label: '뉴스1', title: "'尹 체포방해' 경호처 前 처·차장 징역 7년 구형…내달 9일 선고", url: 'https://www.news1.kr/society/court-prosecution/6184311', date: '2026.6.1' },
            { label: '뉴스데일리', title: "박종준·김성훈 징역 7년 구형…내달 9일 선고", url: 'https://www.newsdaily.kr/news/articleView.html?idxno=257827', date: '2026.6.1' }
        ]
    },
    '이광우': {
        id: 'leegwangwoo',
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 2026.7.9 예정 (서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '체포영장 집행 방해 사건 결심 2026.06.01 종료. 박종준·김성훈(각 7년)에 비해 2년 낮은 5년 구형 — 처장·차장 지휘 라인 아래 현장 책임자로서의 가담 수준이 반영된 것으로 평가'
            }
        ],
        summary: {
            prosecutionTotal: '특수공무집행방해·직권남용·범인은닉: 특검 구형 징역 5년 (2026.06.01 결심)',
            verdictTotal: '체포방해 사건 1심 선고 2026.7.9 예정 (형사26부 이현경)',
            ratio: '체포방해 선고 대기 (구형 5년 — 박종준·김성훈 7년 대비 2년 낮음)'
        },
        keyFacts: [
        ...
        trialStatus: '체포방해 1심 선고 2026.7.9 예정 (형사26부 이현경, 구형 5년)'
    },
    '여인형': {
        id: 'yeoinheong',
        name: '여인형',
    ...
    '윤석열': {
        ...
        charges: [
            ...
            },
            {
                ...
                verdict: '1심 징역 5년 → 항소심 징역 7년 → 상고심 대법원 3부 배당(2026.05.20, 주심 이숙연)',
                reason: '서울고법 형사1부(윤성식 부장판사): "현직 대통령으로서 헌법 준수·국가 보위·국민 자유와 권리 증진의 막중한 책임에도, 사회적 혼란을 가중하는 등 대통령으로서의 책무를 저버렸다". 1심 무죄였던 국무위원 2인 심의권 침해(직권남용), 외신비서관 허위보도 대응 지침 배포 지시도 유죄로 뒤집힘. 경호처 공무원을 "사병처럼 동원". 상고심: 대법원 3부(이흥구·오석준·노경필·이숙연) 배당, 주심 이숙연 대법관 — 윤석열 12·3 비상계엄 관련 첫 대법원 심리. 특검·윤석열 양측 모두 상고'
            },
            {
                id: 3,
                name: '일반이적 (평양 무인기)',
        ...
        summary: {
            ...
            verdictTotal: '내란수괴: 무기징역 (1심, 항소심 진행 중) + 체포방해: 징역 7년 (항소심, 대법원 3부 배당·주심 이숙연) + 위증: 1심 무죄 (2026.05.28, 형사32부 류경진) + 일반이적(평양 무인기): 징역 30년 (2026.06.12, 형사36부 이정엽)',
            ratio: '체포방해 항소심 형량 2년 증가(5년→7년), 위증 무죄 — 내란 관련 기소 사건 중 첫 무죄'
        },
        keyFacts: [
            '대한민국 헌정사상 최초 현직 대통령 구속',
            '2024.12.3 비상계엄 선포',
            '2025.1.15 공수처 체포, 2025.4.4 헌재 탄핵 인용 (파면)',
            '체포방해 1심 징역 5년 (2026.1.16) → 항소심 징역 7년 (2026.4.29) → 상고심 대법원 3부 배당 (2026.05.20, 주심 이숙연)',
        ...
        trialStatus: '내란수괴 항소심 진행 중 (2026.4.27 개시) + 체포방해 상고심 대법원 3부 배당 (2026.05.20, 주심 이숙연) + 위증 1심 무죄 (2026.05.28) + 일반이적(평양 무인기) 1심 징역 30년 (2026.06.12, 형사36부 이정엽)',
        sentencingGuidelines: [
            {
                crime: '내란수괴 (형법 제87조)',
