...
const personsData = {
    ...
    '박종준': {
        ...
        charges: [
            {
                ...
                verdict: '1심 선고 예정 (서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '결심공판 2026.06.01 종료, 선고 일자 추후 지정. 박종준·김성훈 각 7년, 이광우 5년, 김신 3년 구형. 같은 12·3 비상계엄 사건군에서 박종준 본인은 증거인멸 혐의로는 1심 무죄(형사32부 류경진)를 받았으나 체포방해 혐의는 별개 재판부(형사26부 이현경)에서 심리'
            },
            {
                id: 2,
                name: '증거인멸',
        ...
        summary: {
            ...
            verdictTotal: '특수공무집행방해 1심 선고 예정 (형사26부 이현경) / 증거인멸 1심 무죄 (2026.05.21, 형사32부 류경진)',
        ...
        trialStatus: '체포방해 1심 결심공판 종료 (2026.06.01, 구형 7년, 선고 추후) / 증거인멸 1심 무죄 (특검 상고 검토)'
    },
    '김성훈': {
        id: 'kimseonghun',
        name: '김성훈',
        ...
        charges: [
            {
                ...
                prosecutionRequest: '특검 구형 징역 7년 (2026.06.01 결심공판)',
                verdict: '1심 선고 예정 (서울중앙지법 형사합의26부 이현경 부장판사)',
                reason: '체포영장 집행 방해 사건 결심 2026.06.01 종료, 박종준과 동일 7년 구형'
            },
            {
                id: 2,
        ...
        summary: {
            ...
            verdictTotal: '체포방해 사건 1심 선고 예정 (형사26부 이현경)',
        ...
        trialStatus: '체포방해 1심 결심공판 종료 (2026.06.01, 구형 7년) / 비화폰 기록 삭제 직권남용 별도 진행 중'
    },
    '이광우': {
        id: 'leegwangwoo',
        name: '이광우',
        ...
        trialStatus: '체포방해 1심 결심공판 종료 (2026.06.01, 구형 5년, 선고 추후)'
    },
    '여인형': {
        id: 'yeoinheong',
        name: '여인형',
