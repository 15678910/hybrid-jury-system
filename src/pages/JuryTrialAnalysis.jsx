...
const COMPARISON = [
    ...
    {
        axis: '배심원 면접 유무',
        jury: '있음 — 재판장이 질문 주재, 검사·변호인이 무이유부 기피(각 4명)',
...
const LIMITS = [
    ...
    {
        n: '2',
        title: '배심원을 ‘당사자’가 골라낸다 (이해충돌 소지)',
        body: '배심원 후보는 재판장(판사)과 검사·변호인의 면접(질문)을 거치며, 검사·변호인은 이유를 대지 않고도 후보를 각 4명까지 뺄 수 있다(무이유부 기피). 그런데 이 재판은 검찰의 향응·진술회유 의혹과 맞닿은 사건 — 자신의 비위가 걸린 사건에서 검사가 배심원 후보를 이유 없이 빼낼 수 있는 구조 자체가 공정성 시비를 부른다.',
    },
    {
        n: '3',
...
const INTL = [
    { country: '🇰🇷 한국', type: '배심제', mark: 'jury', recruit: '국민 명부에서 사건마다 무작위 추첨', interview: '있음 — 재판장 질문 주재 + 검사·변호인 기피(무이유부 각 4명)', term: '사건 단위 (원칙 1~3일, 이화영 10일은 역대 최장)' },
            ...
            <main className="max-w-4xl mx-auto px-4 pt-24 pb-12">
                ...
                <header className="mb-10">
                    ...
                    <p className="text-gray-600 md:text-lg leading-relaxed mb-4">
                        이 배심원단은 법원이 무작위로 통지한 후보 <strong>500명</strong> 중 출석한 50여 명을 <strong>재판장(판사)과 검사·변호인이 면접(질의응답)</strong>하고, <strong>검사·변호인이 기피</strong>해 본배심원 7명·예비 5명(총 12명)으로 추렸습니다. 이때 검사·변호인은 이유를 대지 않고도 후보를 각 4명까지 뺄 수 있습니다(무이유부 기피). 그런데 이 재판의 핵심 ‘술파티’ 위증은 <strong>검사의 향응·진술회유 의혹</strong>과 맞닿은 사건 — 검찰 비위가 걸린 사건에서 검사가 배심원 후보를 이유 없이 빼낼 수 있는 구조 자체가 이해충돌의 소지를 드러냅니다.
                    </p>
                ...
                <section className="mb-10 bg-white rounded-2xl border border-gray-200 p-6 md:p-8">
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex gap-3">
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                <strong>결론:</strong> ‘무조건 피고인 편’도 ‘무조건 검찰 편’도 아닌 <strong>균형 잡힌 상식</strong>을 보여줬습니다 — 무리한 기소는 만장일치로 깨고, 거짓말(위증)은 다수의견으로 유죄로 인정했죠.
                                그러나 이 배심원단조차 <strong>재판장과 검사·변호인의 면접·기피로 걸러낸</strong> 사람들이고(특히 검사·변호인은 이유 없이도 후보를 뺄 수 있어, 검찰 비위 의혹이 걸린 사건에서 검찰이 배심원 선별에 관여했습니다), 그 평결마저 ‘권고’에 그쳤습니다.
                                시민의 상식이 제대로 작동하려면 — 당사자가 시민을 선별하지도, 그 판단을 ‘참고’에 머물게 하지도 않는 <strong>참심제</strong>가 필요합니다.
                            </p>
                        </li>
                    </ul>
                </section>
