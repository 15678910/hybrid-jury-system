...
const LIMITS = [
    ...
    },
    {
        ...
        body: '배심원은 검사·변호인의 면접·기피를 거쳐 선정된다. 검사·변호인은 이유를 대지 않고도 후보를 각 4명까지 뺄 수 있다(무이유부 기피). 그런데 이 재판은 검찰의 향응·진술회유 의혹과 맞닿은 사건 — 자신의 비위가 걸린 사건에서 검찰이 배심원 선별에 관여하는 구조 자체가 공정성 시비를 부른다.',
    },
    {
        n: '3',
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex gap-3">
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                ...
                                그러나 이 배심원단조차 <strong>검사·변호인이 면접·기피로 걸러낸</strong> 사람들이고(검찰 비위 의혹이 걸린 사건인데도 검찰이 후보를 이유 없이 뺄 수 있었습니다), 그 평결마저 ‘권고’에 그쳤습니다.
