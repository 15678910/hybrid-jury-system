...
const CRIMINAL_PROCEDURE_BILLS = {
    ...
    debates: [
        { title: '공소청의 경찰 직무배제·징계요구권', pro: '부실수사 방지·공소유지 실효성 확보(수사지휘 없이도 최소한의 통제)', con: '사실상 수사지휘 부활·"제2의 검찰"화 우려, 경찰 수사 독립성 침해', finland: '검사에게 경찰 징계·직무배제권을 주지 않는다. 위법·부실수사 통제는 검찰이 아니라 독립 감찰기구(법무총감·의회 옴부즈만) + 경찰 내부 감찰이 맡는다. → 「검사가 경찰을 통제」가 아니라 「독립 감찰이 양쪽을 감시」 — 수사·기소 분리를 지키면서 통제도 확보.' },
