...
const CRIMINAL_PROCEDURE_BILLS = {
    ...
    passedLaw: {
        ...
        articles: [
            ...
            },
            {
                ...
                text: '제245조의11 ④ 제1항부터 제3항까지에 따른 이의제기 절차에 관하여는 「민원 처리에 관한 법률」을 준용하여 반복된 이의제기에 대한 종결처리, 결과 통지 등을 할 수 있다. / 제245조의12 ② … 열람ㆍ등사를 허가하여야 한다. 다만, … 수사의 상황을 고려하여 상당한 이유가 있는 경우에는 열람 또는 등사를 허가하지 아니할 수 있다. / 제245조의7 ③(신설) 제1항 및 제2항의 이의신청은 … 통지를 받은 날부터 3개월 이내에 하여야 한다. / 제245조의13 ② 고소인등은 검사에게 면담을 신청하여 의견진술을 할 수 있다. 이 경우 검사는 사실관계 확인의 필요성을 검토하여 해당 신청의 수리 여부를 결정할 수 있다.',
                ...
                problem: '① 이 법률 전체에서 「국선」이라는 단어는 단 한 번도 등장하지 않는다. 신설·정비된 신청·이의 통로는 일곱 갈래인데, 그 권리를 실질적으로 행사하도록 돕는 국선변호·법률구조·비용 지원 조항은 하나도 없다. 더 정확히 말하면 조력이 잊힌 것이 아니다 — 「변호인의 조력」이라는 표현은 이 법률에 두 번 나오고, 두 번 다 피의자의 것이다(제201조 제8항, 제245조의13 제5항). 입법자는 어디에 붙일지 알고 있었고, 고소인 쪽에는 붙이지 않았다. ② 제245조의11 제4항은 이의제기 절차에 「민원 처리에 관한 법률」을 준용해 반복된 이의제기를 종결처리할 수 있도록 했다 — 준사법적 권리구제가 아니라 행정 민원으로 취급하겠다는 설계다. ③ 열람·등사는 원칙적으로 허가하도록 했지만 「수사의 상황을 고려하여 상당한 이유가 있는 경우」 거부할 수 있어, 다툴 근거가 되는 기록의 접근이 수사기관 재량에 걸린다. 게다가 거부당해도 다툴 절차가 없다 — 이유를 통지받을 뿐이다. ④ 고발인의 이의신청은 「대통령령으로 정하는 범죄」로 한정돼 또 하나의 시행령 위임 지점이 됐다. ⑤ 이의신청에 없던 기한이 새로 생겼고(제245조의7③, 3개월), 이것이 다른 조항과 맞물려 빠져나갈 수 없는 구조를 만든다. 열람·등사 신청권은 목적이 「이의신청을 위하여」로 한정되는데(제245조의12①) 그 신청을 언제까지 처리해야 하는지는 조문에 없다. 기록을 기다리다 3개월이 지나면 이의신청을 할 수 없고, 기간이 지나면 열람·등사를 신청할 근거 자체가 사라진다. 순서를 아는 사람은 이의신청부터 걸어두면 되지만, 모르는 사람에게는 문이 닫힌다. 연장 여부를 판단하는 주체는 불송치를 결정한 바로 그 관서의 장이다. ⑥ 수사 기한과 이의제기 문턱이 어긋난다 — 사법경찰관은 고소·고발 수리일부터 3개월 이내에 수사를 마쳐야 하는데(제238조), 지연을 이유로 이의를 제기하려면 6개월 이상 실질적 수사가 없어야 한다(제245조의11①1호). 3개월 안에 끝내라고 해놓고 다투는 문은 6개월이 지나야 열린다. 이의제기가 받아들여져도 수사관서가 지는 것은 조치 의무가 아니라 통지 의무다. ⑦ 권리 옆에 형벌이 서 있다 — 등사한 기록의 사용목적 제한을 위반하면 1년 이하 징역 또는 500만원 이하 벌금이다(제245조의12⑥). 기록을 어디까지 써도 되는지는 변호인이 있으면 어렵지 않지만, 혼자인 사람에게는 형사처벌이 걸린 판단이 된다. ⑧ 면담(제245조의13②)은 일곱 갈래 중 가장 약하다 — 상대방의 의무도, 거부 사유 제한도, 거부 시 이유 통지도, 불복 절차도 전부 없다. 수리 여부를 가르는 기준은 「사실관계 확인의 필요성」, 즉 검사의 사건 처리에 도움이 되는가이지 고소인에게 설명할 것이 있는가가 아니다. 같은 조 제5항이 피의자에게는 변호인의 조력을 보장하는데 제2항의 고소인 면담에는 그런 규정이 없다. 가정폭력·아동학대·장애인학대·성폭력·스토킹 등 7대 범죄 피해자의 면담을 「최대한 들어야 한다」는 배려는 법률 본문이 아니라 구속력 없는 부대의견에 담겼다. ⑨ 그리고 가장 근본적인 문제 — 절차의 분기점이 늘어난 만큼 형사 변호 시장은 커지는데, 그 비용을 감당할 수 없는 쪽에게는 늘어난 권리가 그림의 떡이 된다.',
                remedy: [
                    ...
                    '★ 면담 신청에도 다툴 곳을 만든다 — 열람·등사조차 거부하려면 이유를 알려야 하는데 면담(제245조의13②)은 그것도 없다. 준항고 규정 한 줄, 또는 상급관서 심사를 준용하는 조항 한 줄이면 된다. 아울러 7대 범죄 피해자의 면담은 「특별한 사정이 없으면 수리하여야 한다」는 한 줄로 부대의견이 아니라 법률 본문에 올려야 한다. 그 한 줄이 본문으로 가지 못하고 부대의견에 남은 것 자체가 이 조항의 성격을 말해준다.',
                    '이의신청 3개월 기한(제245조의7③)과 열람·등사의 상호 잠금을 푼다 — 열람·등사 신청 기간에는 이의신청 기간이 정지되도록 하거나, 열람·등사 처리기한을 조문에 명시한다. 연장 여부의 판단 주체도 불송치를 결정한 그 관서의 장이 아닌 곳으로 옮긴다. 아울러 수사 기한 3개월(제238조)과 이의제기 요건 6개월(제245조의11①1호)의 어긋남을 맞추고, 이의제기 인용 시의 통지 의무를 조치 의무로 바꾼다.',
                    '열람 기록의 사용목적 위반에 걸린 형벌(제245조의12⑥, 1년 이하 징역 또는 500만원 이하 벌금)은 구성요건을 명확히 하고 고의범으로 한정한다 — 권리 옆에 형벌을 세워두면 조력 없는 쪽은 권리 자체를 피한다.',
                ...
                ourRemedy: {
                    ...
                    diff: '통과안: 일곱 갈래의 신청권을 만들었으나 「국선」은 0회 — 권리를 살 수 있는 사람의 권리. 주권자사법개혁추진(준) 안: 변호사 없이도 시민이 직접 판단받고 이의를 제기할 수 있는 통로.',
                },
            },
        ],
        ...
        ourDiff: {
            ...
            rows: [
                ...
                { issue: '「없는 자」의 접근', passed: '신청·이의 통로 7갈래 신설·정비, 그러나 법률 전체에 「국선」 0회 — 조력 없는 신청주의', ours: '변호사 없이도 판단받는 통로(시민기소심사위) + 구술·간이서식 이의제기(시민옴부즈만) + 국선·법률구조 확충', gap: '권리를 만드는 것과 권리를 쓸 수 있게 하는 것은 다른 일이다. 절차가 정교해질수록 그 정교함을 살 수 있는 사람만 이익을 얻는다.' },
    ...
    roadmap: {
        ...
        accessCost: {
            ...
            intro: '통과안은 고소인·피해자의 신청·이의 통로를 일곱 갈래 신설·정비했다 — ① 수사과정 법령위반·인권침해에 대한 시정조치 신청(제197조의3⑧, 안내 의무·진행상황 통지 신설) ② 압수·수색·검증 영상기록 열람·복사 신청(제220조의2④) ③ 불송치 이의신청(제245조의7) ④ 이의제기와 상급관서 심사 신청(제245조의11) ⑤ 수사관계기록 열람·등사(제245조의12) ⑥ 검사 면담 신청·의견진술(제245조의13②) ⑦ 재정신청 확대(제260조). 여기에 공소기각(제327조 제2·3호)이 더해지나 이는 시민의 신청권이 아니라 법원의 재판이다. 그런데 법률 전체에 「국선」이라는 단어는 한 번도 나오지 않는다. 권리를 「신청할 수 있다」로만 설계하면 신청서를 쓸 줄 아는 사람만 권리를 갖게 된다. 시행 이후의 과제는 이 비용의 벽을 어떻게 낮추느냐다.',
            facts: [
