...
const CRIMINAL_PROCEDURE_BILLS = {
    ...
    remedyAnalysis: {
        ...
        ombudsman: {
            ...
            a: '필요하다. 피해자 구제(이의신청·재정신청)는 피해가 발생하고 처분이 난 뒤 당사자가 신청해야 작동하는 「사후·개별」 구제다. 반면 시민옴부즈만은 특정 사건 당사자가 아니어도 주권자인 시민이 수사·기소권 행사 전반을 「평소·상시」 감시하고 시정을 요구하는 시스템적 견제다. 두 형소법 개정안에는 옴부즈만·상시 시민감시 기구가 없다(김용민·박은정 의원안의 수사인권보호관은 수사기관 내부 인권 담당, 공소심의회는 기소 심의로, 독립적 시민 옴부즈만이 아니다). 주권자사법개혁추진준비위원회 안의 「사법감시이중안전법」(사법감찰관+사법옴부즈만)이 이 상시 감시 기능을 담당한다.',
        },
