                ...
                <div className="container mx-auto px-4 overflow-visible">
                            ...
                            >
                                ...
                                <div className={`absolute top-full left-0 mt-0 pt-2 z-[9999] ${trialDropdownOpen ? 'block' : 'hidden'}`}>
                                    <div className="bg-white rounded-lg shadow-lg border py-2 min-w-[200px]">
                                        ...
                                        <Link to="/prediction" className="block px-4 py-2 hover:bg-gray-100 text-gray-700 hover:text-blue-600 whitespace-nowrap">재판 결과 예측</Link>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={`lg:hidden absolute top-full left-0 w-full bg-white border-t border-gray-200 shadow-lg py-4 space-y-2 max-h-[80vh] overflow-y-auto z-40 transition-[opacity,visibility] duration-200 ease-out ${mobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                            ...
                            <div className="border-t border-gray-200 pt-2 mt-2">
                                ...
                                <Link to="/prediction" onClick={() => setMobileMenuOpen(false)} className="block w-full text-left px-6 py-2 hover:bg-gray-100 transition">재판 결과 예측</Link>
                            </div>
