...
export const JUDGES_DATA = [
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 35,
            overallScore: 38,
            summary: '지귀연 부장판사는 윤석열 내란 수괴 재판 재판장으로서 다수의 논란에 휩싸여 있다. 삼성 이재용 부당합병 전부 무죄 판결, 구속취소 시간기준 논란, 재판 비공개 진행 등이 공정성 의문을 제기하고 있으며, 룸살롱 접대 의혹으로 공수처 수사를 받고 있다.',
            issues: [
                {
                    category: '재판부',
                    title: '삼성 이재용 부당합병 전부 무죄',
                    description: '2024년 삼성 이재용 부회장의 부당합병 혐의에 대해 전부 무죄를 선고했다. 대기업 총수에 대한 관대한 판결이라는 비판이 제기되었다.',
                    impact: '→ 재벌 총수에 대한 사법적 형평성 논란'
                },
                {
                    category: '재판부',
                    title: '구속취소 시간기준 논란',
                    description: '윤석열 구속취소 결정에서 71년 관례인 날짜 기준 대신 시간 기준을 적용하여 논란을 일으켰다.',
                    impact: '→ 법적 관례 위반, 피고인 유리 해석 논란'
                },
                {
                    category: '재판부',
                    title: '내란 재판 비공개 진행',
                    description: '전직 대통령 재판을 최초로 비공개로 진행하여 시민단체가 공수처에 고발했다. 재판 공개 원칙에 대한 심각한 위반 논란.',
                    impact: '→ 재판 공개 원칙 훼손, 국민 알 권리 침해'
                },
                {
                    category: '검찰',
                    title: '룸살롱 접대 의혹',
                    description: '2025년 룸살롱 접대 의혹이 제기되어 공수처 수사를 받고 있다. 내란 수괴 재판 재판장의 품위 유지 의무 위반 논란.',
                    impact: '→ 재판부 공정성에 대한 근본적 의문 제기'
                }
            ]
        }
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 48,
            overallScore: 50,
            summary: '우인성 부장판사는 김건희 주가조작 사건에서 징역 1년 8개월을 선고했으나 핵심 주가조작 혐의는 무죄로 판단하여 논란이 있다. 강남 의대생 살인 사건에서 "수능 만점자 사회 기여 가능성" 발언으로 비판을 받았으며, 판결의 일관성에 의문이 제기되고 있다.',
            issues: [
                {
                    category: '재판부',
                    title: '김건희 주가조작 핵심 혐의 무죄',
                    description: '김건희 주가조작 사건에서 징역 1년 8개월을 선고했으나, 핵심인 주가조작 혐의에 대해서는 무죄를 선고했다. 과거 판결에서 다수가 2심에서 뒤집힌 이력도 우려를 더한다.',
                    impact: '→ 구형 대비 1/9 양형, 핵심 혐의 무죄 판단 논란'
                },
                {
                    category: '재판부',
                    title: '강남 의대생 살인 사건 양형 논란',
                    description: '검찰이 사형을 구형한 사건에서 징역 26년을 선고하며 "수능 만점자 사회 기여 가능성"을 언급하여 특권의식 조장 논란이 일었다.',
                    impact: '→ 양형 기준의 형평성 문제 제기'
                }
            ]
        }
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 75,
            overallScore: 73,
            summary: '이진관 부장판사는 한덕수 내란 사건에서 징역 23년을 선고하며 구형보다 8년 높은 판결을 내려 내란 사건에 대한 엄정한 자세를 보여주었다. 이하상 변호사 감치 집행 등 법정 질서 유지에도 단호한 모습을 보였다.',
            issues: [
                {
                    category: '재판부',
                    title: '한덕수 내란 구형 초과 선고',
                    description: '한덕수 전 국무총리 내란 사건에서 검찰 구형(징역 15년)보다 8년 높은 징역 23년을 선고했다. "국가 존립을 위태롭게 한 내란 행위에 엄중한 처벌 필요"라고 밝혔다.',
                    impact: '→ 내란 범죄에 대한 사법부의 엄정한 대응'
                },
                {
                    category: '재판부',
                    title: '법정 질서 유지 단호한 대응',
                    description: '김용현 변호인 이하상 변호사의 법정 소란에 대해 15일 감치를 집행하고, 대법원 특별항고도 기각되어 법정 질서 유지에 단호한 모습을 보였다.',
                    impact: '→ 법정 권위와 재판 진행 정상화에 기여'
                }
            ]
        }
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 72,
            overallScore: 70,
            summary: '류경진 부장판사는 이상민 내란중요임무종사 사건에서 징역 7년을 선고하며 내란에 대한 엄정한 입장을 보였다. 38년간 딸을 간병한 어머니 살인 사건에서 집행유예를 선고하며 사법의 인간적 면모를 보여준 반면, 부장판사 뇌물 무죄 판결 등에서는 법관 간 편파 논란도 있었다.',
            issues: [
                {
                    category: '재판부',
                    title: '이상민 내란 엄정 선고',
                    description: '이상민 전 행정안전부 장관의 내란중요임무종사 사건에서 징역 7년을 선고하며 "국가 존립을 위태롭게 한 내란 행위에 엄중한 처벌 필요"라고 밝혔다.',
                    impact: '→ 내란 가담자에 대한 사법부의 엄정한 대응'
                },
                {
                    category: '재판부',
                    title: '사법의 인간적 판단',
                    description: '38년간 중증 장애 딸을 간병한 60대 어머니의 살인 사건에서 집행유예를 선고하며 "중증 장애인 가족을 지원하지 않는 국가 시스템의 문제"를 지적했다.',
                    impact: '→ 사법 판단에서 사회적 맥락 고려의 모범 사례'
                }
            ]
        }
    },
