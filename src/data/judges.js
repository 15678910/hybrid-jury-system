...
export const JUDGES_DATA = [
    ...
    },
    {
        ...
        reviewCount: 0,
        career: [
            '서울고등법원 형사15-2부 부장판사 (재판장, 현재)',
            '대법원 재판연구관',
            '사법연수원 수료'
        ],
        cases: [
            { text: '김건희 항소심 징역 4년 (2026.04.28) — 1심 1년 8개월에서 대폭 가중. 도이치모터스 주가조작 1심 무죄→항소심 일부 유죄, 통일교 금품수수 1심 일부 유죄→항소심 전부 유죄', source: { name: '서울신문', url: 'https://www.seoul.co.kr/news/society/2026/04/28/20260428500210' } },
            { text: '김건희 항소심 — 그라프 다이아몬드 목걸이(약 6,220만원 상당) 몰수 결정, 추징금 2,094만원 부과', source: { name: 'MBC', url: 'https://imnews.imbc.com/news/2026/society/article/6818598_36918.html' } }
        ],
        justiceEvaluation: {
            prosecutionScore: 75,
            courtScore: 80,
            overallScore: 78,
            summary: '서울고법 형사15-2부 신종오 부장판사는 1심(우인성 부장판사)이 정면 위배했던 대법원 포괄일죄 판례를 정확히 적용하여 도이치모터스 주가조작 공소시효 문제를 해소했고, 통일교 금품수수도 알선수재 법리에 따라 전부 유죄로 확대 판단했다. 1심 대비 형량 2.4배 가중(1년 8개월 → 4년)은 대통령 배우자 지위를 이용한 범죄에 대한 사법부의 균형 회복을 보여준다. 다만 구형 15년 대비 4년은 여전히 검찰 양형기준에 미치지 못하는 측면이 있다.',
            issues: [
                {
                    category: '재판부',
                    title: '대법원 포괄일죄 판례 정확한 적용',
                    description: '신종오 재판부는 도이치모터스 시세조종에 대해 대법원이 동종 사건(권오수·이종호)에서 확립한 포괄일죄 법리를 적용. 1심이 부정한 "20억원 계좌 위탁 + 40% 수익약정 + 통정매매 13만 9,383주"를 단일 범의에 의한 포괄일죄로 인정하여 공소시효 문제를 해소.',
                    impact: '→ 1심 무죄 판단을 정면 뒤집어 항소심 일부 유죄. 사법 정의 회복'
                },
                {
                    category: '재판부',
                    title: '공동정범 법리 명확화',
                    description: '"시세조종행위에 대해 공동 가공의 의사를 갖고 기능적 행위지배를 통해 가담한 것으로 인정된다" — 대통령 배우자라는 지위 특수성을 고려하면서도 형법상 공동정범의 요건을 엄격히 적용.',
                    impact: '→ 향후 유사 사건의 명확한 법리 기준 제시'
                },
                {
                    category: '재판부',
                    title: '통일교 금품수수 — 알선수재 법리 확대 적용',
                    description: '1심이 일부 유죄로 한정한 통일교 금품 수수에 대해 항소심은 알선수재 법리를 폭넓게 적용하여 전부 유죄로 확대. "영부인 지위를 이용한 영리 추구"라는 1심 판단을 강화.',
                    impact: '→ 형량 가중의 핵심 근거. 그라프 목걸이 몰수 결정'
                },
                {
                    category: '재판부',
                    title: '양형기준 — 1심 대비 2.4배 가중',
                    description: '1심 1년 8개월 → 항소심 4년 (벌금 5,000만원 + 추징금 2,094만원 추가). 가중요소로 "죄책 미인정·변명 일관, 시세조종으로 적지 않은 이익 취득, 대통령 배우자 지위로 국정 투명성 훼손, 국론 분열 초래"를 명시.',
                    impact: '→ 1심의 구형 1/9 판결 논란 일부 해소'
                },
                {
                    category: '검찰',
                    title: '항소심 가중 판결 유도 성공',
                    description: '특검이 항소심에서 1심 무죄 부분에 대한 법리 오류를 적극 주장하여 대법원 포괄일죄 판례를 환기. 1심에서 미흡했던 공소장 설계의 부족분을 항소심 변론으로 보완.',
                    impact: '→ 일부 유죄 전환 및 형량 가중 견인'
                },
                {
                    category: '재판부',
                    title: '여전히 구형 15년 대비 27% — 양형 추가 가중 여지',
                    description: '항소심 4년은 1심보다 가중되었으나, 구형 15년 대비 약 27%로 여전히 통상 양형 범위(50~70%)에 미달. 정치자금법 무죄 유지로 윤석열 당선무효 차단 효과는 지속.',
                    impact: '→ 상고심에서 추가 양형 다툼 가능성'
                }
            ]
        }
    },
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 35,
            overallScore: 38,
            summary: '행안부 장관은 경찰·소방 등 치안 조직을 관할하는 핵심 국무위원으로, 내란 시 이를 저지할 헌법적 의무가 있음에도 오히려 가담했다. 특검 구형 15년 대비 47%인 징역 7년은 내란중요임무종사자의 법리적 책임과 국민의 법감정에 비추어 지나치게 관대하며, 검찰의 가담 범위 특정도 미흡하다.',
            issues: [
                {
                    category: '검찰',
