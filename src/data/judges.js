...
export const JUDGES_DATA = [
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 48,
            overallScore: 49,
            summary: '이재명 공직선거법 파기환송 주심을 맡았으며, 법원행정처장 임명과 관련하여 사법개혁 반대 논란이 있다.',
            issues: [
                {
                    category: '재판부',
                    title: '이재명 공직선거법 파기환송 주심',
                    description: '이재명 공직선거법 위반 사건의 파기환송 주심을 맡아 정치적 중립성 논란이 제기되었다.',
                    impact: '→ 정치적 사건 주심으로 중립성 의문'
                },
                {
                    category: '재판부',
                    title: '법원행정처장 임명 논란',
                    description: '2026년 법원행정처장으로 임명되어 사법개혁 반대 논란이 있다.',
                    impact: '→ 사법행정 방향에 대한 우려'
                }
            ]
        }
    },
    ...
    },
    {
        ...
        cases: [
            { text: '윤석열 한덕수 재판 위증 혐의 1심 무죄 선고 (2026.05.28) - 특검 구형 징역 2년, 윤석열 내란 관련 기소 사건 중 첫 무죄. "주관적 평가나 법률적 의견 진술은 위증죄 대상 아냐"', source: { name: '경향신문', url: 'https://www.khan.co.kr/article/202605281010001' } },
            { text: '박종준 전 경호처장 비화폰 삭제 증거인멸 1심 무죄 (2026.05.21) - "보안조치, 증거인멸로 단정 못해", "사후적으로 미흡해도 인멸 추정 불가". 윤석열·홍장원·김봉식 비화폰 정보 원격삭제 관여 혐의', source: { name: '파이낸셜뉴스', url: 'https://www.fnnews.com/news/202605211435463959' } },
            { text: '이상민 내란중요임무종사 징역 7년 선고 (2026.02.12) - 특검 구형 15년 대비 47%, "국가 존립을 위태롭게 한 내란 행위에 엄중한 처벌 필요"', source: { name: '뉴시스', url: 'https://www.newsis.com/view/NISX20260212_0003513827' } },
        ...
        justiceEvaluation: {
            ...
            courtScore: 25,
            overallScore: 30,
            summary: '형사합의32부(류경진 부장판사)는 내란 관련 핵심 피고인 3명(이상민·박종준·윤석열)을 연속 심리하며 모두 무죄 또는 구형 대비 47% 관대한 선고를 내렸다. 특히 박종준 비화폰 삭제(증거인멸)와 윤석열 한덕수 재판 위증을 잇따라 무죄 판결하며 윤석열 내란 관련 첫 무죄를 만들어내, "내란 가담자에게 빠져나갈 법리적 출구를 열어주는 재판부"라는 비판이 제기된다. 검찰·특검의 공소유지도 위증죄 법리·증거인멸 고의 입증에서 거듭 실패하고 있다.',
            issues: [
                {
                    category: '검찰',
                    title: '위증죄 법리 구성 실패 - 주관적 평가 답변에 위증죄 적용',
                    description: '특검은 윤석열이 "국무위원들이 인형도 아니고" 답변으로 한덕수 건의 이전 국무회의 계획을 부인했다며 위증죄로 기소했으나, 재판부는 "주관적 평가·법률적 의견 진술은 위증죄 대상 아님"이라며 무죄. 특검이 위증죄 성립 요건(경험사실의 기억반 진술)을 충족하는 구체적 발언을 특정하지 못한 결과.',
                    impact: '→ 윤석열 내란 관련 기소 사건 중 첫 무죄 판결로 이어짐'
                },
                {
                    category: '검찰',
                    title: '박종준 증거인멸 고의 입증 실패',
                    description: '경호처장이 계엄 직후 윤석열·홍장원·김봉식 비화폰 정보를 원격삭제한 행위에 대해 검찰은 증거인멸로 기소했으나, "사후적으로 미흡해도 인멸 추정 불가" "조태용 협의 후 조치"라는 변론을 깨지 못함. 삭제 시점·내용·맥락에 대한 직접증거 확보 부족과 보안조치라는 외관 방어를 무력화하지 못한 공소유지 실패.',
                ...
                {
                    category: '재판부',
                    title: '내란 관련 핵심 피고인 연속 무죄·관대 선고 패턴',
                    description: '이상민(징역 7년, 구형 47%)→박종준(무죄)→윤석열(위증죄 무죄)로 이어지는 3연속 판결은 형사합의32부가 내란 가담자에게 일관되게 법리적 출구를 제공하는 패턴을 보인다. 동일 재판부에서 단기간(2026.02~05) 내란 관련 핵심 피고인을 연속 무죄·관대 선고한 것은 사법부 내 양형·법리 일관성에 심각한 의문을 제기.',
                    impact: '→ "또 류경진" — 내란 책임 회피 통로로 재판부 지목'
                },
                {
                    category: '재판부',
                    title: '증거인멸 "고의" 해석의 협소함',
                    description: '경호처장이 대통령·국정원·경찰 수뇌부 비화폰을 원격삭제한 행위는 객관적으로 핵심 물증의 소실을 초래했음에도, 재판부는 "보안조치" "조태용과 협의" 등 변명을 받아들여 고의를 부정. 그러나 경호 직무상 보안조치라면 사전 절차·기록이 있어야 하나, 계엄 직후 긴급 원격삭제는 통상 보안조치로 보기 어렵다는 점에 대한 판단 미흡.',
                    impact: '→ 권력자 측근의 증거인멸 면책 선례 형성'
                },
                {
                    category: '재판부',
                    title: '위증죄 법리해석의 피고인 친화성',
                    description: '"주관적 평가는 위증죄 대상 아님"이라는 법리는 일반론으로는 타당하나, 윤석열의 "인형도 아니고" 답변은 단순 평가가 아닌 "한덕수 건의 이전 국무회의 계획 부존재"를 사실로 부인한 답변으로 해석될 여지가 있다. 재판부가 발언의 문맥을 피고인에게 가장 유리하게 해석하여 무죄로 판단한 것은 동일 재판부의 이상민 관대 양형과 함께 패턴화된 피고인 친화성을 보여준다.',
