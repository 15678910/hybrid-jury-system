...
export const JUDGES_DATA = [
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 68,
            overallScore: 67,
            summary: '이재명 공직선거법 파기환송에서 10:2 반대의견을 제시하며 정치적 표현의 자유 확장을 주장했다.',
            issues: [
                {
                    category: '재판부',
    ...
    },
    {
        ...
        cases: [
            { text: '윤석열 전 대통령 공수처 체포방해(특수공무집행방해·직권남용권리행사방해) 상고심 주심 (2026.05.20 대법원 3부 배당, 이흥구·오석준·노경필·이숙연 대법관 심리). 윤석열의 12·3 비상계엄 관련 첫 대법원 심리. 1심 징역 5년 → 2심 징역 7년으로 가중, 특검·윤석열 측 모두 상고', source: { name: '서울경제', url: 'https://www.sedaily.com/article/20046157' } },
        ...
        justiceEvaluation: {
            ...
            issues: [
                ...
                {
                    category: '재판부',
                    title: '체포방해 사건 양형 가중(5년→7년) 대법 판단의 의미',
                    description: '윤석열 체포방해 사건은 1심 징역 5년에서 2심이 징역 7년으로 형량을 가중. 특검은 양형부당·법리오해를 이유로, 윤석열 측은 무죄 또는 감형을 주장하며 양측 모두 상고한 상태. 대법원 3부와 주심 이숙연 대법관의 판단은 본안 내란 사건(1심 무기징역, 항소심 진행)에 대한 대법원의 시각을 가늠하는 풍향계가 될 가능성. 사실심 양형 존중 원칙을 유지할지, 또는 양형부당을 폭넓게 인정해 감형 신호를 보낼지가 핵심.',
                    impact: '→ 본안 내란 상고심 판단에 선례적 영향'
                }
            ]
        }
    },
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 40,
            overallScore: 42,
            summary: '내란수괴 법정형(사형·무기징역·무기금고)의 제약 하에서 무기징역 선고는 법리적으로 타당하나, 외환유치죄 미기소와 노상원 수첩 증거 관리 부실은 수사의 완결성에 심각한 의문을 제기한다. 재판부의 수첩 증거 배척과 재판장 편향 논란은 항소심에서 핵심 쟁점이 될 전망이다.',
            issues: [
                {
                    category: '검찰',
    ...
    },
    {
        ...
        category: '내란전담재판부',
        court: '서울중앙지방법원',
        position: '형사합의26부 부장판사',
        appointedBy: '',
        photo: '/이현경.png',
        rating: 0,
        reviewCount: 0,
        career: [
            '서울중앙지방법원 형사합의26부 부장판사 (현재)'
        ],
        cases: [
            { text: '박종준·김성훈·이광우·김신 윤석열 체포영장 집행 방해(특수공무집행방해·직권남용·범인은닉) 1심 결심공판 (2026.06.01) - 특검 구형: 박종준(전 경호처장) 징역 7년, 김성훈(전 경호처 차장) 징역 7년, 이광우(전 경호본부장) 징역 5년, 김신(전 가족경호부장) 징역 3년. 공소사실: 2024.12.31 윤석열 체포영장 발부 후 박종준이 윤석열 지시로 처장 관저 1층 회의실에서 회의 주재, "공수처 체포영장은 위법"이라며 영장 집행 방해 명령. 2025.01.03 공수처 공무원에 대해 경호처 직원들이 유형력 행사·차벽 설치 등으로 영장 집행 무산. 선고일: 추후 지정', source: { name: '뉴스핌', url: 'https://www.newspim.com/news/view/20260601000751' } }
        ],
        justiceEvaluation: {
            prosecutionScore: 60,
            courtScore: 50,
            overallScore: 55,
            summary: '형사합의26부(이현경 부장판사)는 12·3 비상계엄 직후 공수처의 윤석열 체포영장 집행을 조직적으로 방해한 경호처 핵심 4인(박종준·김성훈·이광우·김신)의 특수공무집행방해 사건을 심리. 2026.06.01 결심공판에서 특검은 박종준·김성훈 각 7년, 이광우 5년, 김신 3년을 구형하며 지휘 위계에 따른 차등 책임을 주장. 같은 박종준이 다른 사건(증거인멸)에서 형사32부 류경진 재판부로부터 무죄를 받은 직후 진행된 재판이라, 동일 인물의 별개 혐의에 대한 재판부별 판단 격차가 본격적으로 시험대에 오른 사건. 선고 결과에 따라 12·3 비상계엄 체포 저지의 사법적 평가가 결정됨.',
            issues: [
                {
                    category: '검찰',
                    title: '지휘 위계에 따른 차등 구형 - 처장·차장 7년, 본부장 5년, 부장 3년',
                    description: '특검은 박종준 전 처장과 김성훈 전 차장에게 동일하게 징역 7년을, 현장 책임자 이광우 경호본부장에게 5년, 가족경호부장 김신에게 3년을 차등 구형하여 지휘 위계와 가담 정도에 비례한 책임론을 구성. 처장-차장 동일 구형은 영장 집행 방해 결정에 양자 동등 참여를 전제로 한 것으로 보임.',
                    impact: '→ 위계별 차등 구형이 양형 단계에서 어떻게 수용될지 관건'
                },
                {
                    category: '재판부',
                    title: '같은 피고(박종준) 다른 재판부 무죄 직후의 사건 - 일관성 시험대',
                    description: '박종준은 같은 12·3 비상계엄 사건군의 증거인멸(비화폰 삭제) 혐의로 2026.05.21 형사32부(류경진)에서 1심 무죄를 받은 직후, 같은 박종준이 핵심 피고인 체포방해 사건이 형사26부(이현경)에서 결심을 마침. 동일 인물의 별개 혐의에 대해 두 재판부가 어떻게 판단을 차별화할지가 사법 일관성의 시험대.',
                    impact: '→ 같은 12·3 비상계엄 사건군의 재판부별 판단 격차 추가 검증'
                },
                {
                    category: '재판부',
                    title: '체포영장 집행 방해의 법치주의 의미 - 양형 핵심 쟁점',
                    description: '법원이 발부한 적법한 체포영장의 집행을 경호처가 조직적으로 무력화한 행위는 법치주의의 근간을 흔드는 사안. 윤석열 체포방해 본인 항소심(서울고법 형사1부 윤성식)이 "법원이 발부한 영장 집행을 물리력으로 저지하려 한 것은 법치주의 원칙에 비춰 허용될 수 없다"며 1심 5년→2심 7년으로 가중한 선례를 형사26부가 어떻게 반영할지 주목.',
                    impact: '→ 형사26부 선고가 12·3 체포방해의 사법적 평가를 사실상 확정'
                }
            ]
        }
    },
    ...
    },
    {
        ...
        category: '내란전담재판부',
        court: '서울중앙지방법원',
        position: '형사합의22부 부장판사',
        appointedBy: '',
        photo: '/조형우.png',
        rating: 0,
        reviewCount: 0,
        career: [
            '서울중앙지방법원 형사합의22부 부장판사 (현재)',
            '사법연수원 수료'
        ],
        cases: [
            { text: "대장동 도시개발 특혜 본류('민관유착 배임') 1심 선고 (2025.10.31) - 화천대유 대주주 김만배 징역 8년·추징 428억, 유동규 전 성남도시개발공사 본부장 징역 8년·벌금 4억, 정민용 변호사 징역 6년·벌금 38억·추징 37.2억, 정영학 회계사 징역 5년, 남욱 변호사 징역 4년 등 민간업자·전직 공직자 전원 실형·법정구속. 배임액 651억→4895억으로 변경, 공범에 이재명·정진상 추가. 다만 유죄 인정이 정영학·남욱 등 검찰에 협력한 핵심 증인 진술에 상당 부분 의존했다는 신빙성 논란, 검찰 항소 포기 논란이 제기됨", source: { name: '한국일보', url: 'https://www.hankookilbo.com/News/Read/A2025103118370004441' } },
            { text: "오세훈 서울시장 정치자금법 위반('명태균 여론조사비 대납') 1심 심리 (2026.3.4 첫 공판, 2026.6.10 공판기일, 6.17 피고인 신문 예정) - 2021년 4·7 서울시장 보궐선거를 앞두고 명태균에게 여론조사를 부탁한 뒤 강철원 전 정무부시장에게 실무를 맡기고 후원자 김씨에게 비용을 대납하게 한 혐의. 오세훈은 혐의 부인, '재판 기일이 지방선거 기간과 일치'한다고 문제 제기. 선고는 6.3 지방선거 이후 예정", source: { name: '경향신문', url: 'https://www.khan.co.kr/article/202604221425001' } }
        ],
        justiceEvaluation: {
            prosecutionScore: 45,
            courtScore: 48,
            overallScore: 46,
            summary: "서울중앙지법 형사합의22부(조형우 부장판사)는 대장동 도시개발 특혜 본류('민관유착 배임')와 오세훈 서울시장 정치자금법 위반('명태균 여론조사비 대납') 등 정치적으로 첨예한 사건을 담당한다(둘 다 12·3 내란과는 직접 관련 없음). 대장동 본류는 2025.10.31 김만배·유동규 각 징역 8년 등 민간업자 전원 실형을 선고했으나, 유죄 인정이 정영학·남욱 등 '자신도 피고인이면서 검찰에 협력한 증인'의 진술에 크게 의존했다는 점에서 진술의 대가성·신빙성 논란과 검찰 항소 포기 논란이 제기된다. 오세훈 사건은 6·3 지방선거 이후 선고 예정이다.",
            issues: [
                {
                    category: '검찰',
                    title: '대장동 — 검찰 협력 증인 진술 의존의 신빙성 논란',
                    description: '대장동 본류 유죄 인정은 정영학(회계사)·남욱(변호사) 등 자신도 피고인이면서 검찰에 협력한 핵심 증인들의 진술에 상당 부분 의존했다. 이들이 형량 감경 등을 기대하고 검찰에 유리한 진술을 했을 가능성, 즉 진술의 대가성·신빙성에 대한 의문이 제기된다. 검찰이 설정한 구도에 협력한 진술만으로 4895억 배임과 거액 추징을 인정한 것이 적정한지 논란.',
                    impact: '→ 협력 증인 진술에 의존한 대장동 판결의 신뢰성 문제'
                },
                {
                    category: '검찰',
                    title: '대장동 — 검찰 항소 포기·선택적 공소유지 논란',
                    description: '1심에서 민간업자 전원 실형이 선고됐으나 일부 쟁점에서 검찰의 항소 포기·부실 공소유지 논란이 제기됐다. 정치적으로 민감한 사건에서 검찰의 선택적 공소유지가 사건 실체 규명과 결과를 왜곡했다는 비판이 있다.',
                    impact: '→ 검찰의 선택적 공소유지가 사건 실체 규명을 저해할 우려'
                },
                {
                    category: '검찰',
                    title: '오세훈 — 여론조사비 대납의 정치자금법 위반 구성',
                    description: '오세훈이 명태균에게 여론조사를 부탁하고 후원자가 비용을 대납했다는 구조를 정치자금법 위반으로 구성. 오세훈은 "부탁한 사실도 동기도 없다"며 부인. 강혜경 등 증인 진술의 신빙성과 자금 흐름 입증이 관건.',
                    impact: '→ 명태균 연루 사건군 전반의 신빙성 판단에 영향'
                },
                {
                    category: '재판부',
                    title: '오세훈 — 재판 기일과 지방선거의 시기 중첩 논란',
                    description: "오세훈 측은 '재판 기일이 6·3 지방선거 기간과 일치한다'며 선거 영향 가능성을 문제 제기. 재판부는 선고를 지방선거 이후로 조정해 정치적 중립성 논란을 일부 완화. 다만 공판 진행 자체가 선거 기간과 겹친 데 대한 절차적 신중함이 요구된다.",
                    impact: '→ 정치인 재판의 선거 시기 중립성 관리 사례'
                }
            ]
        }
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 75,
            overallScore: 73,
            summary: '서울중앙지법 형사합의36부(이정엽 부장판사)는 12·3 비상계엄의 명분을 만들기 위한 평양 무인기 침투 작전(일반이적) 사건을 심리해, 2026.6.12 윤석열·김용현에게 각 징역 30년, 여인형 15년을 선고했다. "비상계엄 상황 조성을 위한 사적 목적의 군 동원"이라는 직권남용과 "군사상 이익 침해"라는 일반이적 공동정범을 정면으로 인정하여, 12·3 계엄의 사전 기획성을 군사 작전 차원에서 사법적으로 확인한 중대 판결로 평가된다.',
            issues: [
                {
                    category: '재판부',
    ...
    },
    {
        ...
        category: '내란전담재판부',
        court: '서울중앙지방법원',
        position: '형사합의23부 부장판사',
        appointedBy: '',
        photo: '/조병구.png',
        rating: 0,
        reviewCount: 0,
        career: [
            '서울중앙지방법원 형사합의23부 부장판사 (현재)',
            '사법연수원 수료'
        ],
        cases: [
            { text: "김용 전 민주연구원 부원장 대장동 불법 정치자금·뇌물 1심 선고 (2023.11.30, 서울중앙지법 형사합의23부) - 2021년 4~8월 유동규 전 성남도시개발공사 본부장 등으로부터 네 차례에 걸쳐 총 8억4700만원의 불법 선거자금/뇌물을 수수한 혐의. 이 중 6억원 수수를 인정해 징역 5년·벌금 7000만원·추징금 6억7000만원 선고. 2심도 동일, 현재 대법원 상고심. 다만 유동규 등 자신도 피고인인 검찰 협력 증인의 진술에 의존했다는 신빙성 논란과 정치적 표적수사 논란이 제기됨", source: { name: '경향신문', url: 'https://www.khan.co.kr/article/202604220600121' } }
        ],
        justiceEvaluation: {
            prosecutionScore: 45,
            courtScore: 48,
            overallScore: 46,
            summary: "서울중앙지법 형사합의23부(조병구 부장판사)는 김용 전 민주연구원 부원장의 대장동 불법 정치자금·뇌물 사건을 심리해 1심에서 징역 5년을 선고했다(12·3 내란과는 무관한 대장동 사건군). 8억4700만원 수수 혐의 중 6억원을 인정했으나, 유동규 등 대장동 핵심 인물(자신도 피고인이면서 검찰에 협력한 증인)의 진술에 의존한 유죄 인정이라는 점에서 진술의 대가성·신빙성 논란과 정치적 표적수사 논란이 제기된다.",
            issues: [
                {
                    category: '검찰',
                    title: '협력 증인(유동규 등) 진술 의존',
                    description: '김용 유죄 인정의 핵심 근거는 유동규 전 성남도시개발공사 본부장 등 자신도 피고인이면서 검찰에 협력한 인물의 진술이다. 형량 감경 등을 기대한 협력 진술의 대가성·신빙성에 의문이 제기되며, 직접 물증보다 진술에 의존한 구조라는 비판이 있다.',
                    impact: '→ 협력 증인 진술에 의존한 판결의 신뢰성 문제'
                },
                {
                    category: '검찰',
                    title: '정치적 표적수사 논란',
                    description: '대장동 사건이 특정 정치세력을 겨냥한 표적수사라는 비판 속에서, 김용에 대한 기소·공소유지가 정치적 동기에서 자유로운지에 대한 논란이 있다. 김용 측은 "불법 선거자금 수수 사실이 없다"며 일관되게 혐의를 부인했다.',
                    impact: '→ 정치적 수사 논란이 판결 신뢰에 미치는 영향'
                }
            ]
        }
    },
