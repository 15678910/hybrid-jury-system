...
export const JUDGES_DATA = [
    ...
    },
    {
        ...
        justiceEvaluation: {
            ...
            courtScore: 50,
            overallScore: 50,
            summary: "서울중앙지법 형사합의22부(조형우 부장판사)는 오세훈 서울시장의 정치자금법 위반('명태균 여론조사비 대납') 사건을 심리 중이다. 이 사건은 12·3 내란과 직접 관련은 없으나, 명태균이 연루된 정치자금 의혹이라는 점에서 김건희 명태균 여론조사 사건과 인물이 겹친다. 재판 기일이 6·3 지방선거와 겹쳐 '선거 영향' 논란이 제기됐고, 재판부는 선고를 지방선거 이후로 조정했다. 2026.6.10 공판기일로 진행 중이다.",
            issues: [
                {
                    category: '검찰',
                    title: '여론조사비 대납의 정치자금법 위반 구성',
