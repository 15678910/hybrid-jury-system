...
export const CARD_NEWS_SERIES = [
    {
        ...
        extra: [
            ...
            { kind: '헌법편', label: '국회는 심의·확정한다 — 노르웨이 법 vs 한국 법안, 그리고 헌법 제1조 (6분 38초)', src: '/cardnews/future-fund-key-2026/constitution-essay.mp4?v=20260917a', download: '헌법편_노르웨이법vs한국법안.mp4' },
            // ⏸ 아래 두 편은 배경음악 확정 대기
