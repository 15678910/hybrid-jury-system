...
export const TRIAL_EVENTS = [
    ...
    },
    {
        ...
        category: 'verdict',
        group: 'political',
        title: "김건희 '매관매직'(알선수재) 1심 선고",
        defendant: '김건희',
        court: '서울중앙지법 형사합의21부',
        judge: '',
        note: "특검이 '현대판 매관매직'으로 규정한 특정범죄가중처벌법상 알선수재 사건. 2022년 이봉관 서희건설 회장에게서 ①사위 박성근 변호사 공직 임명 청탁 명목 반클리프 목걸이·귀걸이 등 1억380만원 ②국가교육위원장 임명 청탁 명목 금거북이(265만원) ③로봇개 사업 지원 청탁+바쉐론 시계(3990만원) ④총선 공천 청탁+이우환 그림(1억4000만원) ⑤디올백 등을 수수한 혐의. 특검 구형 징역 7년 6개월(\"경솔한 처신 반성\"). 6.26 오후 2시 1심 선고(생중계 허가). ※12·3 내란과 별개의 권력형 비리 사건.",
        source: { name: '뉴스핌', url: 'https://www.newspim.com/news/view/20260623000447' },
    },
    {
