...
export const TRIAL_EVENTS = [
    ...
    },
    {
        ...
        category: 'warrant',
        group: 'political',
        title: '이만희 신천지 총회장 구속영장 실질심사 (국민의힘 집단 입당 강요 의혹)',
        defendant: '이만희',
        court: '서울중앙지법 영장전담',
        judge: '김진만 부장판사',
        note: "정교유착 검·경 합동수사본부가 정당법 위반·업무방해 혐의로 6.22 구속영장 청구. 2021.7~2024.1 국민의힘 대선·총선 경선에 영향을 주려 신천지 신도 5만~6만 명에게 책임당원 가입을 강요한 혐의('필라테스 프로젝트' 등 명목으로 독려). 6.24 오후 2시 서울중앙지법(김진만 영장전담 부장판사)에서 구속 전 피의자 심문. 앞서 고동안 전 총회 총무 등 간부 3명은 6.17 구속(증거인멸·도주 우려). 신천지 측은 '영장 청구는 유감이며 충실히 소명하겠다'며 혐의를 부인. ※12·3 내란과 무관한 별개 사건.",
        source: { name: '아주경제', url: 'https://www.ajunews.com/view/20260623101716752' },
    },
    {
        id: 'leehwayoung-jury',
        date: '2026-06-20',
